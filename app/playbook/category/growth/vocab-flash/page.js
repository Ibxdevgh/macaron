...
const screenshots = [
  {
    src: "/assets/_next/689375f56eea5637c0438ad2-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689375f56eea5637c0438ad2-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689375f56eea5637c0438ad2-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689375f56eea5637c0438ad2-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Vocab Flash Pro | Macaron - Macaron
    </title>
    <meta
      name="description"
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/689375f56eea5637c0438ad2.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Master English vocabulary your way! Create custom flashcards, set your level (A1-B2), and let the smart review system guide your learning journey. Each interactive card packs English words, pronunciation guides, and clear definitions. The clever spacing system remembers what you know and when to review — making sure those new words stick!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Choose your English level and get vocabulary words that perfectly match where you are in your learning journey.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Explore new words with beautiful flashcards that show pronunciation and meanings with a simple tap.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track your progress by marking words you&apos;ve mastered, helping you focus on what you still need to learn.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get gentle reminders to review words exactly when you need them, based on how well you know each word.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Focus on learning with a distraction-free interface that makes studying feel natural and effortless.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                See English words with Chinese translations to build confident understanding of new vocabulary.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Macaron, let&apos;s build a \&quot;Vocabulary Flash\&quot; mini-app. I want a simple program to match my English level (A1, A2, B1, B2) and get custom word lists. Core features: flashcard review with flip animation, and smart reminders. After studying each word, I&apos;ll mark if I remember it, and get review reminders in 1 or 3 days. Cards show the word, pronunciation, and Chinese meaning. Keep it clean and simple — just tap to flip!&quot;
      </div>
      <span
        aria-hidden="true"
