...
const screenshots = [
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8ad3-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8ad3-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8ad3-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8ad3-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Music Conservatory Guide | Macaron - Macaron
    </title>
    <meta
      name="description"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Music Conservatory Guide icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/6893a8f996e8fcf6105f8ad3.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Music Conservatory Guide
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                  Your guide to top music schools
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to find your perfect music school? Jump into our interactive guide to top conservatories worldwide! Compare rankings, acceptance rates, and costs at a glance, plus get personalized advice for your path - whether you&apos;re into performance, composition, or conducting. Let&apos;s help you hit the right note in your musical journey!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              At-a-Glance Conservatory Comparison

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Compare top music schools side-by-side with easy-to-scan details on programs, rankings, acceptance rates, and costs.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Explore dynamic charts that help you understand how different conservatories stack up in rankings and value for money.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get tailored admission advice for your chosen path, whether you&apos;re pursuing performance, composition, or conducting.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Browse smoothly through comprehensive school information on any device, from phone to desktop.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Organize school information your way by sorting any criteria that matters most to your decision.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Follow a clear, structured approach to explore and compare schools at your own pace.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s create your ultimate music school guide! I&apos;ll compare 8 top conservatories, breaking down their specialties, QS rankings, acceptance rates, and tuition. You&apos;ll get a clear comparison table, visual charts for rankings and stats, plus expert advice for performance, composition, and conducting paths. Ready to find your perfect match?&quot;
      </div>
      <span
        aria-hidden="true"
