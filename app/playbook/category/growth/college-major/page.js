...
export default function CollegeMajor() {
const screenshots = [
  {
    src: "/assets/_next/6894e26d1e005cbfbd244a51-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6894e26d1e005cbfbd244a51-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6894e26d1e005cbfbd244a51-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6894e26d1e005cbfbd244a51-4.png",
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="College Major Insights icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/6894e26d1e005cbfbd244a51.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Smart major matching for every student
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Explore and compare popular university majors in China through comprehensive data analysis and personalized guidance. Browse through 8 detailed major cards with interactive charts visualizing key metrics, and get custom recommendations based on your career interests. Make informed decisions about your academic future with easy access to employment stats, salary data, and admission requirements.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Major Explorer Cards

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Discover quick insights on 8 popular majors, including real employment stats, starting salaries, and admission requirements.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Compare employment rates and other key metrics that matter for your future with easy-to-read charts.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find majors that match your interests and strengths, whether you&Apos;re creative, analytical, or people-oriented.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Easily switch between sections to explore major details, compare data, and find your perfect path.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Compare different majors through interactive charts that make complex information instantly understandable.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;I&apos;d like a report on top Chinese university majors from Macaron. Could you list the core courses, employment rates, starting salaries, and admission difficulty for 8 popular majors? Please include bar charts for employment rates and a radar chart comparing salaries and difficulty levels, plus recommendations based on different interest types.&quot;
      </div>
      <span
        aria-hidden="true"
