...
const screenshots = [
  {
    src: "/assets/_next/6892ff56af303aa30e9442a5-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892ff56af303aa30e9442a5-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892ff56af303aa30e9442a5-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6892ff56af303aa30e9442a5-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6892ff56af303aa30e9442a5.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Jump into your perfect ice-breaker quiz! Take 5 quick questions to unlock personalized conversation starters that match your unique style. Swipe through custom openers, save your favorites, and discover what works best for you. Ready to spark genuine conversations on your dates?
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into five fun questions about your style and interests to unlock conversation starters that match your vibe!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get 15 unique ice-breakers crafted just for you — making those first date chats flow naturally and feel real.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Browse your starters with a fun card system — swipe right to save your favorites, left to skip to the next!
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
             Your Dating Style Insights

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track your favorite conversation moves and discover your unique dating personality as you go.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find your perfect opener with smooth, satisfying swipes and taps — browsing has never felt this good!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Keep all your winning conversation starters in one spot, ready whenever you need that perfect ice-breaker!
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s build DateBuddy with Macaron! Create a fun mini-app that learns your style through 5 quick personality questions, then serves up 15 perfect ice-breakers as swipeable cards. Like or pass on each suggestion to help fine-tune your dating game!&quot;
      </div>
      <span
        aria-hidden="true"
