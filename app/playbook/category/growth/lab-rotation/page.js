...
export default function LabRotation() {
const screenshots = [
  {
    src: "/assets/_next/6893a06e96e8fcf6105f899f-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f899f-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f899f-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f899f-4.png",
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Lab Rotation Schedule Maker icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/6893a06e96e8fcf6105f899f.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Make lab rotations crystal clear
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Plan your lab rotations like a pro! Keep track of schedules, tasks, and prep work across different research periods. Easily manage rotation dates, advisor assignments, and research focuses, with clear timelines and guidelines for each phase. Perfect for grad students and coordinators who want to document their rotation journey.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Smart rotation calendar

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See your complete research schedule at a glance, from lab assignments to advisor meetings and key topics.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your research goals and deadlines on track with an organized timeline for each rotation.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Get ready for each rotation with tailored reading lists and step-by-step lab guides.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Move smoothly between rotation periods to check your upcoming lab assignments.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Create clean, well-formatted documents of your schedule and requirements to share and reference.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
               Check your rotation plans and lab guidelines anywhere, from your desk to the lab.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, create a lab rotation planner for me! I need a report with three rotation periods, including timing, advisors, research focus, and key tasks. Also add tips for literature review and reagent prep.&quot;
      </div>
      <span
        aria-hidden="true"
