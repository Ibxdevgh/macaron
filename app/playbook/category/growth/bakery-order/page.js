...
const screenshots = [
  {
    src: "/assets/_next/8cb158e7-4141-475f-a867-946a4b202dd3.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/bc9febfa-656c-431a-b1d2-70bc19e76d9a.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/4fd56c20-f01c-4cba-ac5f-abab63f90e0f.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/2266f293-f5c8-4128-b576-8cee27f790bb.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Bakery Order Central | Macaron - Macaron
    </title>
    <meta
      name="description"
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6892fe28af303aa30e94429c.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Bakery Order Central
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Fresh bakery orders made just for you
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Create your dream bakery storefront online! Showcase your delicious breads, cakes, and signature treats in a beautiful catalog, while customers easily browse and order with just a few clicks. Orders go straight to your inbox — no hassle, just sweet success.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Showcase Your Sweet Delights

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Bring your breads and pastries to life with a stunning homepage filled with mouthwatering photos that make treats irresistible.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
             Update Menus in a Snap

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Add your latest creations in minutes with simple tools to upload photos and descriptions of your fresh-baked goodies.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Let customers order their favorites 24/7 with a simple form that sends orders directly to your inbox.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Help customers discover your full range of treats with an organized, user-friendly product catalog.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Stay on top of every order with instant email notifications for new customer requests.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s team up with Macaron to create your BakingHome Website Builder! We&apos;ll set up a beautiful bakery site with a homepage showcasing your signature breads and cakes, a product gallery where you can upload mouthwatering photos and descriptions, and a smart order form to collect customer details and send orders straight to your inbox.&quot;
      </div>
      <span
        aria-hidden="true"
