...
export default function LawStudyGuide() {
const screenshots = [
  {
    src: "/assets/_next/6893a06e96e8fcf6105f8975-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f8975-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f8975-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f8975-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Law Study Guide — Legal wisdom at your fingertips — unlock it now |
      Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Ready to master the legal classics? Dive into a guided journey through eight essential law books, perfectly organized for your level. Track your progress, unloc..."
    />
    <meta property="og:title" content="Law Study Guide" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6893a06e96e8fcf6105f8975.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Law Study Guide" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893a06e96e8fcf6105f8975.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
        Ready to master the legal classics? Dive into a guided journey through eight essential law books, perfectly organized for your level. Track your progress, unlock detailed insights, and follow smart study paths that make complex legal texts feel achievable. Whether you&apos;re a law student or future legal eagle, your structured path to mastery starts here!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Level up your law journey with eight essential textbooks, perfectly arranged to guide you from start to finish.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Unlock the power of each recommended book with quick overviews that spotlight key topics and their impact on your legal path.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Master your legal readings with custom strategies and pro tips designed to maximize your learning from each textbook.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch your skills grow with color-coded study stages that map your journey from rookie to expert.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find your next read in seconds with clean, organized entries showing titles, authors, and challenge levels.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Take your law guide anywhere – it works perfectly whether you&apos;re on your laptop or phone.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Create my ultimate law reading guide! Macaron will help you build a curated report with 8 must-read books from beginner to expert level. Each book comes with author info, perfect study timing, content overview, and personalized tips to level up your legal knowledge.&quot;
      </div>
      <span
        aria-hidden="true"
