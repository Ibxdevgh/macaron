...
export default function LoveConfessor() {
const screenshots = [
  {
    src: "/assets/_next/485fd625-96d4-4c4e-b1f9-f7640f62661b.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/648fced1-4bac-4539-ae63-8f104c7af846.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/8da212d3-b38c-451b-916b-8d58c8109746.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/eaa7c19d-19bd-4426-911f-82cd6d509fe0.png",
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68932b82066d1f5e094dceaa.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Words of love, right when they matter
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to express your heart? Tell me about your special someone, your story together, and your style — I&apos;ll craft three perfect love confessions just for you, plus tips on the best moment to share them. Let&apos;s make your confession unforgettable!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Create heartfelt messages that truly reflect your special someone&apos;s personality and your unique bond.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Pick from three perfectly crafted options that match your vibe - from sweet and casual to deeply romantic.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get smart tips on when to share your feelings, backed by natural social patterns and psychology.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
             Easy Message Preview

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Browse different styles, find your perfect match, and share it instantly with that special someone.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Relationship-Smart Design

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Whether it&apos;s a new crush or close friend, tell us about your connection and we&apos;ll nail the perfect tone.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, help me create a Confession Matchmaker! I want to craft the perfect love letter based on their gender, how close we are, and the right vibe. Give me three sweet message templates and tell me the best hour to hit send — you know, for maximum heart-flutter effect!&quot;
      </div>
      <span
        aria-hidden="true"
