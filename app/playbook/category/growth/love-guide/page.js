...
const screenshots = [
  {
    src: "/assets/_next/6893a06e96e8fcf6105f899c-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f899c-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f899c-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f899c-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Love Guide Pro | Macaron - Macaron
    </title>
    <meta
      name="description"
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893a06e96e8fcf6105f899c.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to level up your love game? This fun guide helps you craft the perfect confession to your college crush! Plan your heartfelt moment with confidence using our interactive checklist, customize your special message, and get smart tips on when and where to make your move. With step-by-step support and backup plans ready, you&apos;ll feel prepared to share your feelings — no matter how the story unfolds!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into a quick quiz that helps you feel confident about your timing and emotional readiness before sharing your heart!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Craft the perfect message with three unique letter styles and personalized tips that make your words truly special.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Be ready for anything! Get smart tips for handling different responses, plus a caring shoulder to lean on when you need it.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
             Perfect Moment Finder

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find that magical moment! Get savvy tips on when and where to share your feelings for the perfect confession scene.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Level up your confession game with clear, friendly guidance that walks with you every step of the way.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Access your love coach anywhere - phone or computer! Everything you need in a clean, easy-to-read style.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Create your perfect confession guide — get pro tips on self-reflection and timing, sample heartfelt letters, sweet gift ideas, and smart strategies to handle any response!&quot;
      </div>
      <span
        aria-hidden="true"
