...
const screenshots = [
  {
    src: "/assets/_next/6892550cc28019528d81a771-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892550cc28019528d81a771-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892550cc28019528d81a771-3.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Business Plan Builder | Macaron - Macaron
    </title>
    <meta
      name="description"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Business Plan Builder icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/6892550cc28019528d81a771.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Build your business strategy in minutes! Input your details and get a ready-to-use plan with five key sections — perfectly tailored to your industry and product. Copy sections individually or grab the whole plan to share your vision and get moving.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Instant Business Plan Creator
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump in and craft your pro business plan in minutes — just tell us about your industry and product!
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Smart 5-Section Structure
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch your plan organize itself into five powerful sections, each packed with strategic insights to fuel your success.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Ready to show off your plan? Share the whole thing or pick your favorite sections — all it takes is one click.
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            From basic info to brilliant business plan in just three easy steps — we&apos;ll guide you all the way!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           See your whole plan at a glance with our clean, organized design that makes every section pop.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s create a Business Plan Generator mini-app with Macaron! Just input your industry and product details, and I&apos;ll craft a structured outline with five key sections: market analysis, product & service, business model, team & organization, and financial forecast. Each section comes with three ready-to-copy bullet points for your document.&quot;
      </div>
      <span
        aria-hidden="true"
