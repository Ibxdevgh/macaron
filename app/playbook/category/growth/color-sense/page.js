...
export default function ColorSense() {
const screenshots = [
  {
    src: "/assets/_next/68933492b492847205282050-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68933492b492847205282050-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68933492b492847205282050-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68933492b492847205282050-4.png",
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Color Sense Challenge icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/68933492b492847205282050.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Train your eye to spot true hues
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to test your color vision? Race against time in this 20-question challenge! Compare color swatches, pick the darker or lighter shade within 10 seconds, and discover your true color perception skills. Track your speed, accuracy, and unlock a detailed performance report at the finish line!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Race through 20 exciting color matches! Test your eye and spot the subtle differences in this rapid-fire challenge.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Think fast! You&apos;ve got 10 seconds per match. Trust your instincts and make every moment count!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch your color mastery level up! See how your speed and accuracy improve with every match you make.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Unlock your color perception score instantly! Get a detailed breakdown of your performance right after you finish.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Ready for another round? Take on fresh color combinations and train your eye to spot even the tiniest differences!
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Ready to create the ultimate color challenge? Let&apos;s build a Color Vision Test where you&apos;ll race against time to spot subtle differences! Each round shows you 2 color swatches—pick the darker one before 10 seconds run out. After 20 quick-fire rounds, see your score, speed, and color sensitivity rating. Pure, focused, and fun!&quot;
      </div>
      <span
        aria-hidden="true"
