...
const screenshots = [
  {
    src: "/assets/_next/68923e96c28019528d81a5f1-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68923e96c28019528d81a5f1-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68923e96c28019528d81a5f1-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68923e96c28019528d81a5f1-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Trend Pulse: Your Social Media Scanner | Macaron - Macaron
    </title>
    <meta
      name="description"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Trend Pulse: Your Social Media Scanner icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/68923e96c28019528d81a5f1.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Trend Pulse: Your Social Media Scanner
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Uncover the story behind quarterly trends
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Dive into your quarterly reports and discover what&apos;s trending! Upload multiple reports to instantly reveal key themes, watch them evolve through dynamic charts, and get the scoop on your top 5 rising patterns. Your go-to analysis buddy for spotting what matters in your organization&apos;s story.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Import all your quarterly reports in one simple step, with automatic date organization to keep everything tidy.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Instantly uncover the key topics and patterns within your reports, without having to read through everything manually.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch how different themes evolve over time with beautiful, interactive charts that make patterns pop at a glance.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get an instant snapshot of your top 5 emerging themes, complete with helpful insights about why they matter.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See your quarterly data transform into a clear visual story that helps you spot opportunities and track progress.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Ready to create your Market Trend Pulse with Macaron? Just upload your reports, and I&apos;ll analyze word frequencies, chart quarterly trends, and highlight the top 5 emerging themes with a quick insight summary.&quot;
      </div>
      <span
        aria-hidden="true"
