...
export default function EduTrend() {
const screenshots = [
  {
    src: "/assets/_next/6893471db492847205282290-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893471db492847205282290-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893471db492847205282290-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893471db492847205282290-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      EduTrend Insight | Macaron - Macaron
    </title>
    <meta
      name="description"
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893471db492847205282290.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Jump into smart market analysis! Create stunning trend reports for online education with interactive charts and clear insights. Your data comes alive through scrollable sections and responsive visuals that work on any device. Track growth, spot risks, and uncover golden opportunities — all in one easy-to-navigate dashboard.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See online education trends at a glance with crystal-clear charts and growth predictions that make sense instantly.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Growth Story Navigator

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Unlock the secrets behind online education&apos;s success with bite-sized, fact-packed market insights.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get instant alerts about online education challenges with clear, no-nonsense warning signals.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
             Future Opportunities Spotlight

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Explore three exciting paths in online education – each ready for you to act on right away.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Smooth Section Browsing

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Zip through the report with our smart menu – always know exactly where you are.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
               Enjoy your insights anywhere – the report looks perfect on every screen, from desktop to phone.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&apos;s create a Trend Radar! I need a detailed trend analysis for online education - give me a 300+ word report covering the industry&apos;s 3-year CAGR, market projections, key growth drivers, risk factors, and three concise 30-word future opportunities.&quot;
      </div>
      <span
        aria-hidden="true"
