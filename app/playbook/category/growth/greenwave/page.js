...
const screenshots = [
  {
    src: "/assets/_next/6892550cc28019528d81a777-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892550cc28019528d81a777-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892550cc28019528d81a777-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6892550cc28019528d81a777-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
     <title>
      GreenWave Energy — Power up tomorrow&#x27;s world with clean energy today
      | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Create stunning websites for renewable energy companies! Showcase green solutions and cutting-edge tech with professionally designed pages. Your site comes pack..."
    />
    <meta property="og:title" content="GreenWave Energy" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6892550cc28019528d81a777.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="GreenWave Energy" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6892550cc28019528d81a777.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Create stunning websites for renewable energy companies!
                  Showcase green solutions and cutting-edge tech with
                  professionally designed pages. Your site comes packed with
                  everything you need: smooth navigation, company info, solution
                  galleries, team spotlights, and a news hub. Plus, it&#x27;s
                  SEO-optimized and looks amazing on any device — all wrapped in
                  an earth-friendly design that makes an impact.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Effortlessly explore our story, solutions, team, and
                      latest news with smooth, intuitive menus.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Discover our innovative renewable energy solutions through
                      detailed project showcases and real-world success stories.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Meet the passionate experts at GreenWave through engaging
                      profiles and environmental expertise.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Stay updated with our news section featuring the latest in
                      renewable energy.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Experience our commitment to sustainability with a fresh,
                      nature-inspired design that shines on any device.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find all you need about renewable solutions with our
                      clearly organized, user-friendly layout.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Jump in and craft a sleek website for GreenWave, the
                  renewable energy innovator! We&#x27;ll showcase their
                  cutting-edge energy storage tech with a powerful green design.
                  I&#x27;ll whip up engaging Home, Solutions, Team, and News
                  pages, complete with SEO-optimized meta tags, ready to export
                  as a static site. Let&#x27;s make it shine!&quot;
      </div>
      <span
        aria-hidden="true"
