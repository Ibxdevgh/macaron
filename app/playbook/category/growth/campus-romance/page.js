...
export default function CampusRomance() {
const screenshots = [
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8b1e-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8b1e-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8b1e-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8b1e-4.png",
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893a8f996e8fcf6105f8b1e.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Campus Romance Guide
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                  College dating made safe and sweet
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to level up your campus dating game? This guide&apos;s got everything you need to make meaningful connections — from acing those first chats to planning unforgettable dates. Navigate relationships like a pro while keeping it safe and fun. Whether you&apos;re starting fresh or deepening bonds, find quick tips for any situation!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get friendly, practical tips to meet new people and spark confident conversations on campus.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Discover budget-friendly date adventures perfect for college life, from campus events to local hotspots.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Master the art of showing you care, navigate conflicts smoothly, and build lasting connections.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
             Dating Safety Essentials

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Date with confidence using clear guidance on boundaries, trust-building, and smart safety practices.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find what you need instantly with our smooth, mobile-friendly menu system.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
              Grasp concepts quickly with engaging graphics and illustrations that make tips stick.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, create a guide for college dating! I need tips on meeting people, planning dates, cute gift ideas, handling conflicts, and staying safe. Make it available offline too!&quot;
      </div>
      <span
        aria-hidden="true"
