...
const screenshots = [
  {
    src: "/assets/_next/68933785b4928472052820b9-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68933785b4928472052820b9-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68933785b4928472052820b9-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68933785b4928472052820b9-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
     <title>
      MBTI Personality Match — Discover your gaming spirit animal | Macaron -
      Macaron
    </title>
    <meta
      name="description"
      content="Ready to discover your gaming DNA? Take this quick 12-question quiz to unlock your MBTI personality type and find your perfect match in the gaming world! We&#39;ll ..."
    />
    <meta property="og:title" content="MBTI Personality Match" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68933785b4928472052820b9.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="MBTI Personality Match" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68933785b4928472052820b9.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to discover your gaming DNA? Take this quick 12-question quiz to unlock your MBTI personality type and find your perfect match in the gaming world! We&apos;ll analyze your unique traits and reveal which genres are destined to be your favorites — all based on how you naturally think and play.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into a fun 12-question adventure that reveals your personality type in minutes!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Unlock your perfect game matches! Get personalized recommendations based on your unique traits.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Dive deep into your personality profile and discover what makes you uniquely you!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch your journey unfold with a friendly progress bar showing how close you are to the finish line.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Express yourself freely with simple, crystal-clear questions and answers that just click.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Ready for a replay? Take the quiz again anytime to track how your personality evolves!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            No waiting around - get your personality profile and game matches the moment you finish!
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&apos;s create a fun MBTI quiz! I want a mini-app that takes me through 12 personality questions, each with four choices. Once I&apos;m done, show me my four-letter type, what it means about me, and suggest three perfect game genres to match my personality. Oh, and let me retake it whenever I want!&quot;
      </div>
      <span
        aria-hidden="true"
