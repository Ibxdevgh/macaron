...
const screenshots = [
  {
    src: "/assets/_next/6893652cdef845e53c83bff9-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893652cdef845e53c83bff9-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893652cdef845e53c83bff9-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893652cdef845e53c83bff9-4.png",
...
<>
 ...
 icon"
                      ...
                      src="/assets/_next/6893652cdef845e53c83bff9.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Jump into risk-free stock trading! Practice your investment moves with real market data, starting with $100,000 in virtual cash. Buy, sell, and watch your portfolio grow with real-time updates on profits, costs, and returns. Ready to try a new strategy? Reset anytime and start fresh!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Jump in with Zero Risk

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Start your trading adventure with $100,000 in virtual cash — learn the ropes without risking real money!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Build your skills using authentic market data and real stock prices from trading history.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Buy and sell with intuitive controls that make trading feel as natural as playing a game.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Track your success in real-time with instant updates on profits, losses, and portfolio performance.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Ready to try a new strategy? Reset your balance to $100,000 whenever you want!
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&apos;s create Stock Master Arena — a practice zone where you start with 100,000 in virtual funds! Trade with real one-week market data, set your buy/sell orders with custom prices and quantities. Watch your balance update live with position P&L tracking, cost basis, current prices, and total ROI. Hit reset anytime to start fresh!&quot;
      </div>
      <span
        aria-hidden="true"
