...
const screenshots = [
  {
    src: "/assets/_next/689375916eea5637c0438ab7-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689375916eea5637c0438ab7-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689375916eea5637c0438ab7-3.png",
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/689375916eea5637c0438ab7.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Daily chat starters to light up your social life
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to become a conversation pro? Get fresh topics and natural dialogue examples daily! Discover three new ice-breakers every day, complete with smart questions and responses you can use right away. Save your favorite starters, track what works best in the calendar, and build your own collection of winning conversation moves. Time to make every chat count!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Start each day with three new conversation starters that help you connect with others naturally and confidently.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get five thoughtful questions and responses for each topic, making it easy to keep conversations flowing smoothly.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Browse through your past conversation topics by date, so you always have interesting things to discuss with different people.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep track of your most successful conversation starters by marking topics and questions you love for quick access later.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Simply tap any topic to instantly see all its questions and suggested responses, helping you prepare for any social situation.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&apos;s create a SocialBuddy mini-app! I want it to serve up three fresh conversation starters every day, with five engaging questions and sample responses for each topic. Plus, I&apos;d love to keep track of past topics and bookmark my favorites for later!&quot;
      </div>
      <span
        aria-hidden="true"
