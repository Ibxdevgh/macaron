...
const screenshots = [
  {
    src: "/assets/_next/689423c8a5f5880a362aaa93-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689423c8a5f5880a362aaa93-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689423c8a5f5880a362aaa93-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689423c8a5f5880a362aaa93-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Master Office Chat Like a Pro | Macaron - Macaron
    </title>
    <meta
      name="description"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Master Office Chat Like a Pro icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/689423c8a5f5880a362aaa93.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Master workplace chats like a pro! Get ready-made templates for daily updates, approvals, and feedback that help you nail every conversation with your boss. With real examples and go-to phrases at your fingertips, you&apos;ll always strike the right tone — from quick check-ins to important requests.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Write perfect work emails in seconds with our pre-written templates for every situation. Just pick, customize, and send!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Share ideas with managers confidently using our proven professional phrases and expert tips.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Master workplace conversations with practical, real-life examples that show you exactly what works.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find what you need instantly with clear sections for greetings, updates, requests, and more.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your guides handy with clean, well-formatted printouts for quick desk reference.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Take your guides anywhere — looks perfect on both phone and computer.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Create a guide to ace workplace communication! Learn perfect openers for supervisor chats, nail your daily updates, master decision requests, share feedback smoothly, and wrap up conversations like a pro. Your complete starter pack for workplace success with Macaron!&quot;
      </div>
      <span
        aria-hidden="true"
