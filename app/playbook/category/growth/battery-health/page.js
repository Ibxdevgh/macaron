...
const screenshots = [
  {
    src: "/assets/_next/68925c71c28019528d81a88c-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68925c71c28019528d81a88c-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68925c71c28019528d81a88c-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68925c71c28019528d81a88c-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Battery Health Scanner | Macaron - Macaron
    </title>
    <meta
      name="description"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Battery Health Scanner icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/68925c71c28019528d81a88c.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Battery Health Scanner
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Smart battery stats, just ask!
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Dive into CATL&apos;s solid-state battery tech through an interactive hub! Compare specs, track milestones, and visualize trends with dynamic charts and timelines. Whether you&apos;re on desktop or mobile, unlock deep tech insights with just a few taps. Perfect for researchers and industry pros looking to power up their knowledge!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into battery tech through an interactive flowchart — unlock detailed insights and research with just one click!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Race through a decade of battery breakthroughs! See how solid-state tech evolved from 2015 to 2025.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Performance Battle Station

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Put battery solutions head-to-head! Compare different manufacturers and discover who leads the pack.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Peek into tomorrow&apos;s battery tech! Dive into crystal-clear visuals showing what&apos;s next in the industry.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Level up your tech knowledge! Access battery formulas, terms, and research all in one power-packed space.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
               Your research adventure stays smooth whether you&apos;re on desktop or mobile — perfect visuals, zero hassle!
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Report Topic: White Paper on CATL&apos;s Cutting-Edge Applications in Solid-State Batteries
        Requirements:
        <ul className="list-disc list-inside space-y-1 text-sm sm:text-lg leading-relaxed break-words">
        <li>Literature review with technical principle flowchart, marking key process steps and reference IDs</li>
        <li>Core technology roadmap (2015–2025) with timeline annotations of major breakthroughs</li>
        <li>Comparative table of at least 3 domestic and international case studies with performance metrics</li>
        <li>Future-trend prediction model description, including a simplified formula or logic diagram with assumptions noted</li>
        <li>Data sources: SCI journal articles and expert interview summaries</li>
        <li>Appendix: glossary of terms, formula explanations, and links to raw data</li>
        <li>Formatting: flowcharts with arrow connectors; tables with 1 pt gray borders</li>
        </ul>
            </div>
      <span
        aria-hidden="true"
...
<div className="mb-8 sm:mb-12">
  ...
  <Link
    className="block"
    href="/playbook/category/growth/career-fortune"
  >
    <div className="group relative w-full flex flex-col rounded-3xl overflow-hidden cursor-pointer bg-[#F1EFE9] border border-[#E9E7E2] transition-all duration-300 ease-out hover:shadow-lg h-[364px]">
      <div className="w-full flex-1 relative overflow-hidden flex flex-col">
        <div className="p-5 pb-2 flex flex-col z-30 flex-shrink-0">
        ...
        <div className="flex-1 relative flex items-center justify-center pointer-events-none mt-3">
          <div
            role="img"
            aria-label="Career Fortune Quiz screenshot 1"
            className="top-0 absolute w-[60%] aspect-[9/19.5] rounded-[12px] bg-white shadow-xl z-20 transition-transform duration-300 ease-out group-hover:-translate-y-3 bg-origin-border bg-cover bg-center"
            style={{
              backgroundImage:
                "url(/assets/project_template/68933791b4928472052820be-1.png)"
            }}
          />
        </div>
      </div>
