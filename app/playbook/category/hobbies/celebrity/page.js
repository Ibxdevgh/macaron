...
const screenshots = [
  {
    src: "/assets/_next/c44e9161-a503-4fd0-ac75-f9e8e04c6fe6.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/31b88e36-2882-4283-900b-7e7ef2366206.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/f4b32d27-6e2c-4c38-bd7c-fba4861383ff.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/3867fc3e-a306-4a32-87c3-95ab9f955272.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
     Celebrity photo merge | Macaron - Macaron
    </title>
    <meta
      name="description"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Celebrity photo merge icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/68b5d608ac093020edb47d7b.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Jump into the ultimate photo fusion experience! Upload your pic, pick a celebrity (like Elon Musk or Taylor Swift), or choose your own star, and watch as AI crafts a stunning mashup that looks incredibly real. Create shareworthy social posts or fun memories in seconds!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Celebrity Photo Magic

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into the spotlight — create stunning photos with your favorite stars in just a few taps!
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Star-Studded Gallery

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Browse our curated collection of popular celebrities or add your own star to craft the perfect shot!
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
            Sleek Night Mode Design

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Immerse yourself in an elegant dark interface that&apos;s gentle on your eyes and makes your photos shine.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Transform your shots into celebrity moments in seconds — it&apos;s that fast and simple!
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Choose a photo and create an epic crossover with your favorite celebrity! Pick from our star-studded lineup (Trump, Putin, Musk, Macron, Swift, Rihanna, James, DiCaprio, Beyoncé) or add any other celeb you&apos;d love to meet.
      </div>
      <span
        aria-hidden="true"
