...
export default function EsportsTrivia() {
const screenshots = [
  {
    src: "/assets/_next/689337cfb4928472052820e1-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689337cfb4928472052820e1-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689337cfb4928472052820e1-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689337cfb4928472052820e1-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Esports Trivia Challenge | Macaron - Macaron
    </title>
    <meta
      name="description"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Esports Trivia Challenge icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/689337cfb4928472052820e1.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Esports Trivia Challenge
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Ready to dominate the esports scene? Jump in now!
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to unlock your true gaming style? Jump into this quick 10-question quiz and discover if you&apos;re born to be an Assault warrior, Support hero, master Sniper, or strategic Commander! We&apos;ll analyze your reaction speed, team skills, and tactical thinking to match you with perfect games for your playstyle.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Take a quick 10-question quiz to uncover your unique esports style and find games you&apos;ll love.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Answer straightforward questions about your gameplay with clear options that reveal your gaming preferences.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get matched with your perfect player type - Assault, Support, Sniper, or Commander - based on how you naturally play.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get handpicked game suggestions that match your unique playing style and preferences.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Follow your journey with a friendly progress bar that shows how close you are to discovering your style.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Curious about other playstyles? Take the quiz again anytime to explore how your gaming personality evolves.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Macaron, let&apos;s build an \ &quot;Esports Style Test\ &quot; mini-app. I need a 10-question quiz with four options each focusing on reaction speed, teamwork, leadership, and tactics. Score ranges: 0-19 Assault, 20-29 Support, 30-39 Sniper, 40-50 Commander. The results page should show style name, description, and recommended game types.&quot;
      </div>
      <span
        aria-hidden="true"
