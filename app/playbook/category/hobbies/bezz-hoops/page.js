...
export default function BezzHoops() {
const screenshots = [
  {
    src: "/assets/_next/68933211b492847205282002-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68933211b492847205282002-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68933211b492847205282002-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68933211b492847205282002-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68933211b492847205282002.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Build an all-star landing page for your basketball club! Showcase your team&apos;s spirit with a stunning hero section, share contact info, and let your best moments shine in a dynamic photo gallery. Everything adapts perfectly to any screen, making it a slam dunk for attracting new members and keeping your club connected.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Jump into the action with a stunning basketball-themed welcome screen that brings Bezz Club&apos;s energy right to you!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Connect with us instantly - all our contact details are just one tap away, from calls to emails and directions.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Dive into the Bezz experience through dynamic action shots, team celebrations, and exclusive facility tours.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Glide through our story, photos, and info effortlessly - perfect on any device you choose.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Discover the heart of Bezz Basketball Club through our clean, easy-to-explore layout.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
       Got it! Let&apos;s create an eye-catching promo page for Bezz basketball club. I&apos;ll help you design something that really pops, with all the essential contact details front and center!
