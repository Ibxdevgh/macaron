...
const screenshots = [
  {
    src: "/assets/_next/689337a4b4928472052820ce-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689337a4b4928472052820ce-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689337a4b4928472052820ce-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689337a4b4928472052820ce-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Arcade Shooter Quiz | Macaron - Macaron
    </title>
    <meta
      name="description"
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/689337a4b4928472052820ce.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to unlock your true gaming potential? Take our quick 10-question challenge and discover your perfect shooter style! We&apos;ll analyze your reflexes, aim, map sense, and team play to reveal if you&apos;re born to be an Assault warrior, elite Sniper, tactical Support, or stealthy Guerrilla fighter. Get personalized insights and weapon picks to dominate the battlefield!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Quick Gaming Style Quiz

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into a fun 10-question challenge that reveals your natural combat style and how you tackle the action!
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Instant Playstyle Match

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find your perfect combat role – Assault, Sniper, Support, or Guerrilla – based on how you love to play!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Unlock your ideal arsenal – get custom weapon and loadout picks that match your unique fighting style!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your eye on the prize with a simple progress bar showing how close you are to revealing your style!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See your complete warrior profile in one sleek page – from combat style to gear recommendations!
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Macaron, let&apos;s build a \&quot;Shooter Pro Style Test\&quot; mini-app! Create 10 quick-fire questions to reveal my combat style - from reaction speed to team tactics. Score ranges unlock my warrior path: 0-19 Assault (run & gun), 20-29 Sniper (precision master), 30-39 Support (team backbone), or 40-50 Guerrilla (tactical genius). Show me my battle style, signature moves, and perfect loadout!&quot;
      </div>
      <span
        aria-hidden="true"
