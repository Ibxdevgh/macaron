...
const screenshots = [
  {
    src: "/assets/_next/6892e40e7bac40bbf77f6e33-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892e40e7bac40bbf77f6e33-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892e40e7bac40bbf77f6e33-3.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Your Perfect Book Finder — Find your perfect book match | Macaron -
      Macaron
    </title>
    <meta
      name="description"
      content="Jump into your perfect reading adventure! Tell me about a book you loved and why it clicked with you — I&#x27;ll match you with four carefully picked reads that shar..."
    />
    <meta property="og:title" content="Your Perfect Book Finder" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6892e40e7bac40bbf77f6e33.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Your Perfect Book Finder" />
    <meta
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Your Perfect Book Finder icon"
                      loading="lazy"
                      width="80"
                      height="80"
                      decoding="async"
                      ...
                      src="/assets/_next/6892e40e7bac40bbf77f6e33.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Jump into your perfect reading adventure! Tell me about a book
                  you loved and why it clicked with you — I&#x27;ll match you
                  with four carefully picked reads that share that special
                  spark. Keep exploring with instant new suggestions, and track
                  your whole discovery journey with a searchable recommendation
                  history.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Share Your Reading Joy
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Tell us about a book you loved and why it resonated with
                      you to get personalized recommendations that match your
                      taste.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Discover four handpicked books with personalized notes
                      explaining why each one matches your reading preferences.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Explore different book suggestions anytime with one tap
                      while keeping your original favorite book as inspiration.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Look back at all your past book discoveries and
                      recommendations to track your literary exploration over
                      time.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Clear your recommendation history whenever you want to
                      begin a new chapter in your reading adventure.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Let&#x27;s create a personalized book finder! Tell me a book
                  you loved and why it clicked with you. I&#x27;ll suggest 4
                  perfect matches, complete with titles, authors, and quick
                  recommendations. Want different picks? Just hit refresh. You
                  can check your past suggestions or start fresh anytime.
      </div>
      <span
        aria-hidden="true"
