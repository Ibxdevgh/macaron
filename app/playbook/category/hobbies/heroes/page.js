...
export default function HeroesEntwined() {
const screenshots = [
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8af4-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8af4-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8af4-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893a8f996e8fcf6105f8af4-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Heroes Entwined | Macaron - Macaron
    </title>
    <meta
      name="description"
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893a8f996e8fcf6105f8af4.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Jump into an epic adventure with Iron Man and Spider-Man! Follow their mentor-mentee story through easy-to-navigate chapters that look great on any device. Dive into this polished fan fiction experience with crystal-clear text and smooth reading flow that keeps you hooked from start to finish.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into an original adventure where Iron Man and Spider-Man team up! Experience action and mentorship like never before in this thrilling tale.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Breeze through the story your way! Simple controls let you hop between chapters at whatever pace suits you best.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Comfort-First Reading

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Dive into perfectly sized text with eye-friendly spacing that makes every page a joy to read.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Your adventure follows you everywhere - enjoy seamless reading on your phone, tablet, or computer.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            No downloads, no waiting - just tap and jump straight into the action!
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, create me a report on Iron Man and Spider-Man fan fiction!&quot;
      </div>
      <span
        aria-hidden="true"
