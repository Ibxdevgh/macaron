...
const screenshots = [
  {
    src: "/assets/_next/68932251601f00cd55f715a4-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68932251601f00cd55f715a4-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68932251601f00cd55f715a4-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68932251601f00cd55f715a4-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Romantic Getaway Designer — Dream honeymoons tailored just for you |
      Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Plan your dream honeymoon in minutes! Just answer 5 quick questions, and we&#39;ll craft three perfect itineraries packed with romantic stays, unforgettable activit..."
    />
    <meta property="og:title" content="Romantic Getaway Designer" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68932251601f00cd55f715a4.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Romantic Getaway Designer" />
    <meta
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Romantic Getaway Designer icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/68932251601f00cd55f715a4.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Dream honeymoons tailored just for you
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Plan your dream honeymoon in minutes! Just answer 5 quick questions, and we&apos;ll craft three perfect itineraries packed with romantic stays, unforgettable activities, and smooth travels. Compare costs, save your favorites, and make your special getaway planning a breeze. Ready to start your adventure together?
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump in with five quick questions about your dream spots, budget, and travel style to unlock your perfect honeymoon match!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get three tailor-made getaway plans packed with daily adventures, dreamy hotels, and smooth travel connections.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See exactly where every dollar goes with crystal-clear cost estimates that keep your dream trip within budget.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Follow your adventure from start to finish with easy-to-navigate daily timelines of your romantic journey.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find your perfect match at a glance by comparing different honeymoon options side by side.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your favorite plans close at hand — access them anytime while planning your special getaway.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s build a Honeymoon Planner with Macaron! Answer 5 quick questions about your dream escape (beach vibes or city lights? adventure or luxury?) and unlock 3 personalized itineraries. Each route comes packed with daily activities and budget breakdowns. Save your favorites and start dreaming big - we&apos;ll handle the planning magic!&quot;
      </div>
      <span
        aria-hidden="true"
