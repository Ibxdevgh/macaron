...
const screenshots = [
  {
    src: "/assets/_next/689377546eea5637c0438b0d-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689377546eea5637c0438b0d-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689377546eea5637c0438b0d-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689377546eea5637c0438b0d-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Ergonomic Chair Finder — Find chairs that fit your body perfectly |
      Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Find your perfect office chair in seconds! Just tell us your height, weight, and budget — we&#x27;ll match you with the most comfortable ergonomic chairs that fit yo..."
    />
    <meta property="og:title" content="Ergonomic Chair Finder" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/689377546eea5637c0438b0d.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Ergonomic Chair Finder" />
    <meta
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/689377546eea5637c0438b0d.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Find chairs that fit your body perfectly
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Find your perfect office chair in seconds! Just tell us your
                  height, weight, and budget — we&#x27;ll match you with the
                  most comfortable ergonomic chairs that fit you perfectly. No
                  more endless searching, just smart recommendations tailored to
                  you.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Enter your height and weight to unlock chair
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
          Tell us your budget and discover comfy office chairs that
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get two personalized chair picks instantly matched to your
                      unique needs.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Compare your recommended chairs side by side and pick your
                      perfect match.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&#x27;s make a Chair Comfort Workshop with Macaron!
                  Jump in and create a web app that matches you with the perfect
                  office chair. Just enter your height (cm), weight (kg), and
                  budget (CNY), and I&#x27;ll recommend two ideal chairs that
                  fit you perfectly!&quot;
      </div>
      <span
        aria-hidden="true"
