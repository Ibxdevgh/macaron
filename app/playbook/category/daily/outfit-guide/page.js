...
export default function OutfitGuide() {
const screenshots = [
  {
    src: "/assets/_next/52f561c0-0d62-4073-af59-4a0e33fc1b46.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/056a02f8-5bde-4e1d-967f-f593e8a08403.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/ef2ab438-bd96-49be-811f-c8549e77f368.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/2318f52a-b8e5-4b81-8cf3-5e8f644edb36.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Outfit Guide Pro — Perfect outfits for every moment ahead | Macaron -
      Macaron
    </title>
    <meta
      name="description"
      content="Create your perfect outfit in seconds! Tell us your event and the weather, and we&#39;ll craft a complete look — from clothes to accessories — with smart style tips..."
    />
    <meta property="og:title" content="Outfit Guide Pro" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68931bca601f00cd55f71536.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Outfit Guide Pro" />
    <meta
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68931bca601f00cd55f71536.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Perfect outfits for every moment ahead
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Create your perfect outfit in seconds! Tell us your event and the weather, and we&apos;ll craft a complete look — from clothes to accessories — with smart style tips to help you shine at any occasion.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Smart Occasion Planner
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Tell us your event and the weather — we&apos;ll instantly craft the perfect outfit suggestions for any occasion.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Complete Look Creator
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get stunning head-to-toe looks with perfectly matched clothes, shoes, and accessories that work in harmony.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Master event dress codes with expert tips to ensure you&apos;re always dressed just right.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Look amazing in any weather — get outfit ideas that match both your event and the temperature.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See your outfit picks in a clean, organized view that shows exactly what to wear and how to mix and match.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              On-the-Go Style Guide
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Take your personal fashion advisor anywhere — works beautifully on all your devices.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s create an Occasion Outfit Helper with Macaron! Tell me the event and weather, and I&apos;ll suggest the perfect outfit combo (from top to shoes and accessories) that nails both dress code and comfort — whether it&apos;s for job interviews, weddings, dinner parties, or social gatherings.&quot;
      </div>
      <span
        aria-hidden="true"
