...
export default function DressUpMaster() {
const screenshots = [
  {
    src: "/assets/_next/6c736833-8197-43da-a0ae-c7d08d28b750.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/788a3352-838c-4152-ada4-aa4670b10f73.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/94effad4-a7e8-47cf-af46-092508105db9.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/954ec68b-0daf-490c-88fe-76171ae97726.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Dress-up Master — Try clothes on instantly | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Turn any pose into your perfect fashion showcase! Upload a full-body photo and clothing image — watch as your style vision comes to life with seamless, pro-qual..."
    />
    <meta property="og:title" content="Dress-up Master" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-accelerate.aliyuncs.com/image/project_icon/68b571ea1e5b36e68812174c.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Dress-up Master" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68b571ea1e5b36e68812174c.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Turn any pose into your perfect fashion showcase! Upload a full-body photo and clothing image — watch as your style vision comes to life with seamless, pro-quality outfit visualizations. Quick, easy, and totally Instagram-worthy.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Try on any outfit with just a tap — see it on your photo while keeping your exact pose and expression perfect.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Rock your new style from head to toe with seamlessly generated full-body images.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Transform your look instantly with our clean, focused interface that puts fashion front and center.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Generate a full-body photo with different outfits while keeping the pose unchanged.
      </div>
      <span
        aria-hidden="true"
