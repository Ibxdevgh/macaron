...
const screenshots = [
  {
    src: "/assets/_next/6893138b1bb07ead242b868e-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893138b1bb07ead242b868e-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893138b1bb07ead242b868e-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893138b1bb07ead242b868e-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Beauty Brand Central — Natural beauty for modern radiance | Macaron -
      Macaron
    </title>
    <meta
      name="description"
      content="Create a stunning beauty brand website that captivates visitors with elegant product displays and flowing layouts. Showcase your story through a sleek responsiv..."
    />
    <meta property="og:title" content="Beauty Brand Central" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6893138b1bb07ead242b868e.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Beauty Brand Central" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893138b1bb07ead242b868e.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Create a stunning beauty brand website that captivates
                    visitors with elegant product displays and flowing layouts.
                    Showcase your story through a sleek responsive design with
                    hero banners, curated galleries, and smart contact forms —
                    all wrapped in harmonious pastels and minimalist style. Turn
                    browsers into customers with this polished digital
                    storefront!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Step into a world of pure radiance with our stunning
                        showcase of premium products and inspiring beauty
                        stories.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Explore our handpicked skincare, makeup, and haircare
                        treasures with vivid photos and expert details.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Discover our passion for natural ingredients and how
                        we&apos;re shaping a new era of authentic beauty.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Connect with our beauty specialists instantly through
                        our quick contact form or visit us in person.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Experience seamless shopping and stunning visuals on any
                        device, anytime.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Indulge in peaceful shopping with our soothing colors
                        and elegant, minimalist design.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Build a stunning website for LOVIO beauty company that
                    captures their brand essence.&quot;
      </div>
      <span
        aria-hidden="true"
