...
export default function VeganMeal() {
const screenshots = [
  {
    src: "/assets/_next/68944b4a454dbedec39a684c-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68944b4a454dbedec39a684c-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68944b4a454dbedec39a684c-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68944b4a454dbedec39a684c-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Vegan Meal Genius — Planet-friendly, protein-packed vegan feasts | Macaron
      - Macaron
    </title>
    <meta
      name="description"
      content="Ready to cook up some planet-friendly power? Whip up 5 protein-packed vegan recipes weekly, each packing 15g+ of pure plant power while keeping things green! Ge..."
    />
    <meta property="og:title" content="Vegan Meal Genius" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-accelerate.aliyuncs.com/image/project_icon/68944b4a454dbedec39a684c.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Vegan Meal Genius" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68944b4a454dbedec39a684c.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to cook up some planet-friendly power? Whip up 5 protein-packed vegan recipes weekly, each packing 15g+ of pure plant power while keeping things green! Get exact portions, nutrition facts, and easy-to-follow steps to create delicious meals that love you back — and Mother Earth too!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Create your perfect week of vegan meals instantly! Each recipe packs the protein you need while being kind to our planet.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Kitchen-Ready Recipe Cards

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump right into cooking with crystal-clear instructions and precise measurements. Making delicious meals has never been easier!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track your protein goals at a glance while making eco-friendly food choices that help our planet thrive.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Mix up your meal plan anytime you want! Swap in fresh recipes while keeping your nutrition goals on track.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Plan your cooking schedule with confidence - each recipe shows exactly how long it&apos;ll take from start to finish!
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&apos;s create a GreenBite mini-app for eco-friendly meal planning! I need a weekly plan with 5 vegan dishes. Each meal should pack at least 15g of protein while keeping the carbon footprint under 2kg CO₂. Please include the recipes, ingredient amounts, and easy cooking instructions.&quot;
      </div>
      <span
        aria-hidden="true"
