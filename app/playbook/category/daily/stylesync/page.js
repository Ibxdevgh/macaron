...
const screenshots = [
  {
    src: "/assets/_next/68936c05def845e53c83c0a3-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68936c05def845e53c83c0a3-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68936c05def845e53c83c0a3-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68936c05def845e53c83c0a3-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
     <title>
      StyleSync — Style your perfect day with a dream closet | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Transform your daily style game! Upload your wardrobe, and let&#39;s create perfect outfits for any occasion. Just tell us the weather and event, and we&#39;ll mix and ..."
    />
    <meta property="og:title" content="StyleSync" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68936c05def845e53c83c0a3.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="StyleSync" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68936c05def845e53c83c0a3.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Transform your daily style game! Upload your wardrobe, and
                    let&apos;s create perfect outfits for any occasion. Just tell us
                    the weather and event, and we&apos;ll mix and match your tops,
                    bottoms, shoes, and accessories into stunning looks with
                    killer color combos. Getting dressed has never been more
                    fun!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Snap photos of your clothes to build a personalized
                        virtual wardrobe that organizes everything from tops to
                        accessories.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get outfit suggestions perfectly matched to today&apos;s
                        temperature, so you&apos;re always dressed comfortably for
                        the weather.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Tell us where you&apos;re headed—work, date, or casual
                        outing—and we&apos;ll suggest outfits that fit the occasion
                        perfectly.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Receive head-to-toe outfit combinations that coordinate
                        your clothes, shoes, and accessories in harmonious color
                        palettes.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Simply enter the day&apos;s weather and plans to instantly
                        see stylish outfit options from your own wardrobe.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            View beautiful color combinations for each outfit
                        suggestion to ensure your look is perfectly coordinated.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Let&apos;s create your personal AI stylist with Macaron! Upload
                    your wardrobe photos with categories, set the weather (hot
                    &gt;25°C, mild 15-25°C, cool &lt;15°C) and occasion (work,
                    date, or casual), and get perfect outfit combos with
                    matching accessories and color schemes.
      </div>
      <span
        aria-hidden="true"
