...
export default function SauceMaster() {
const screenshots = [
  {
    src: "/assets/_next/6894129c129a8b22ebbd18f6-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6894129c129a8b22ebbd18f6-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6894129c129a8b22ebbd18f6-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6894129c129a8b22ebbd18f6-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Sauce Master — &quot;Master sauce making: from fresh ingredients to perfect
      storage&quot; | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Master the art of sauce making! Calculate perfect portions, follow pro mixing steps, and keep your creations fresh with this handy kitchen companion. Easily sca..."
    />
    <meta property="og:title" content="Sauce Master" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6894129c129a8b22ebbd18f6.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Sauce Master" />
    <meta
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6894129c129a8b22ebbd18f6.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   &quot;Master sauce making: from fresh ingredients to perfect storage&quot;
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Master the art of sauce making! Calculate perfect portions, follow pro mixing steps, and keep your creations fresh with this handy kitchen companion. Easily scale recipes, tweak ingredients to your taste, and learn the best ways to store every sauce.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Level up your sauce game! Browse delicious recipes and tweak them to match your taste perfectly.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Just tell us how much you need — we&apos;ll instantly adjust all ingredients to keep that perfect flavor balance.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Follow our pro tips step by step! Learn the exact mixing tricks and techniques for restaurant-worthy sauces.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get smart storage tips tailored just for you — from picking the right container to knowing when your sauce is at its best.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s make a SauceLab mini-app with Macaron! Choose from tasty options like garlic or Thai chili sauce, and get exact ingredients, perfect seasoning ratios, and mixing steps. Plus, learn how to seal and store your sauce for up to 2 weeks in the fridge!&quot;
      </div>
      <span
        aria-hidden="true"
