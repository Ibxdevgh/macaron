...
const screenshots = [
  {
    src: "/assets/_next/6892edb8aa6e16ed138ee502-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892edb8aa6e16ed138ee502-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892edb8aa6e16ed138ee502-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6892edb8aa6e16ed138ee502-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6892edb8aa6e16ed138ee502.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Get ready for your next adventure! Just tell us your travel dates, where you&apos;re headed, and what you&apos;ll be up to — we&apos;ll whip up the perfect packing list. With smart weather tracking and trip length in mind, you&apos;ll know exactly what to bring. Add your must-haves, tweak the list, and save it for next time. Never forget your essentials again!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Tell us your travel plans and we&apos;ll whip up the perfect packing list for your adventures!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get spot-on packing tips based on your destination&apos;s forecast and planned activities.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Add your must-haves or skip what you don&apos;t need - customize your list to fit your style.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Just drop in your travel dates and destination - get a complete packing list in minutes!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Access your past lists anytime to quickly gear up for similar trips ahead.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Macaron, help me make an app that creates packing lists automatically from my travel plans.&quot;
      </div>
      <span
        aria-hidden="true"
