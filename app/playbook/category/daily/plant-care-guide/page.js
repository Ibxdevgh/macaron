...
const screenshots = [
  {
    src: "/assets/_next/6881a5e5f2b772db424839a9-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6881a5e5f2b772db424839a9-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6881a5e5f2b772db424839a9-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6881a5e5f2b772db424839a9-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Plant Care Guide — Turn a photo into your personal plant care guide |
      Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Take a photo of your houseplant and unlock expert care secrets! Get instant plant ID and detailed guides for light, water, and nutrients. Whether you&#x27;re a first..."
    />
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6881a5e5f2b772db424839a9.png"
    />
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6881a5e5f2b772db424839a9.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Turn a photo into your personal plant care guide
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Take a photo of your houseplant and unlock expert care
                  secrets! Get instant plant ID and detailed guides for light,
                  water, and nutrients. Whether you&#x27;re a first-time plant
                  parent or a seasoned green thumb, grow with confidence!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Just snap a photo of any indoor plant and instantly
                      discover its variety — no green thumb required!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get custom care tips for your plant, from perfect sunlight
                      spots to watering schedules designed just for you.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
             Got plant photos already? Upload them from your gallery
                      and unlock the mystery of every plant in your collection.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
             Dive into detailed profiles of hundreds of indoor plants,
                      with expert tips to help each one flourish.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Custom Care Calendar
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Never miss a plant care day again! Get perfect timing for
                      watering and feeding, customized for each of your green
                      friends.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&#x27;s make a smart plant helper with Macaron! Just
                  snap or upload a photo of your plant (whole plant or leaf),
                  and I&#x27;ll identify the species and give you a custom care
                  guide. You&#x27;ll get everything you need: ideal light
                  conditions, when to water, and fertilizer tips. Here&#x27;s
                  what it can do: – Green ivy: Thrives in filtered light, water
                  every 7-10 days, boost with 5 ml all-purpose liquid fertilizer
                  monthly – Cactus: Loves bright light, water every 14-21 days,
                  feed with special cactus food monthly – Peace lily: Perfect
                  for low light, water every 5-7 days, nourish with 10 ml
                  balanced fertilizer monthly – Pothos: Happy in filtered light,
                  water every 6-9 days, treat with 8 ml diluted fertilizer twice
                  a month – Orchid: Prefers indirect light, water every 10 days,
                  feed with orchid mix every 3 weeks&quot;
      </div>
      <span
        aria-hidden="true"
