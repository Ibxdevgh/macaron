...
export default function PhoneShowdown() {
const screenshots = [
  {
    src: "/assets/_next/6894f5021e005cbfbd244b9f-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6894f5021e005cbfbd244b9f-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6894f5021e005cbfbd244b9f-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6894f5021e005cbfbd244b9f-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
  <title>
      Phone Showdown: Your Ultimate Buyer&apos;s Guide — Find your perfect phone
      match today | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Jump into the ultimate phone finder! Compare top flagship phones head-to-head, from raw power to camera skills. Interactive charts help you match the perfect pr..."
    />
    <meta
      property="og:title"
      content="Phone Showdown: Your Ultimate Buyer&#39;s Guide"
    />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-accelerate.aliyuncs.com/image/project_icon/6894f5021e005cbfbd244b9f.png"
    />
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6894f5021e005cbfbd244b9f.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                   Phone Showdown: Your Ultimate Buyer&apos;s Guide
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                  Find your perfect phone match today
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Jump into the ultimate phone finder! Compare top flagship phones head-to-head, from raw power to camera skills. Interactive charts help you match the perfect premium device to your style—whether you&apos;re chasing the best shots or the best deal. Dive into specs, battery life, and more to make your next phone your perfect match!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Easy phone comparison

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Line up the best smartphones side-by-side and get the scoop on screens, cameras, storage, and prices to find your ideal match.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Speed & power insights

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Quickly see how phones measure up in real-world speed with easy-to-read visual comparisons.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           See which phones offer the best balance of battery longevity and portability to suit your lifestyle.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
             Personalized phone picks

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Snag custom phone suggestions based on what you need, whether you&apos;re snapping photos, gaming hard, or budgeting wisely.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Easily compare phones on any device with a sleek, flexible layout perfect for both mobile and desktop.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Tap or hover over charts to get the full scoop and make phone feature comparisons more fun and insightful.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Ready to create your ultimate phone comparison? I&apos;ll whip up a detailed guide comparing these top phones, complete with performance charts and personalized picks just for you!&quot;
      </div>
      <span
        aria-hidden="true"
