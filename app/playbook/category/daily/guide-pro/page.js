...
const screenshots = [
  {
    src: "/assets/_next/6894419938b4126bb126cb00-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6894419938b4126bb126cb00-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6894419938b4126bb126cb00-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6894419938b4126bb126cb00-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Gift Guide Pro — Create birthday gifts that tell their perfect story |
      Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Turn gift-giving into a breeze! Create stunning birthday gift guides with handpicked recommendations across 5 lifestyle categories. From budget-friendly finds t..."
    />
    <meta property="og:title" content="Gift Guide Pro" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6894419938b4126bb126cb00.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Gift Guide Pro" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6894419938b4126bb126cb00.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Turn gift-giving into a breeze! Create stunning birthday
                    gift guides with handpicked recommendations across 5
                    lifestyle categories. From budget-friendly finds to premium
                    treasures, each guide comes packed with perfect pairings,
                    pricing details, and where to buy. Your go-to companion for
                    crafting professional gift recommendations that wow!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Smart Gift Collections
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into five beautifully curated gift worlds! From
                        dazzling jewelry to unforgettable experiences, each
                        category comes alive with stunning visuals to spark your
                        perfect pick.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find treasures for every budget! Browse clear price
                        tiers across categories, from delightful affordable
                        finds to luxurious premium picks.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get straight to gifting! See exactly where and how to
                        snag each item, with a smooth, stress-free path from
                        browse to buy.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Level up your gifting game! Mix and match complementary
                        items to create magical gift combinations that&apos;ll make
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Beautiful Gift Gallery
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Step into a world of wonder! Browse our stunning gift
                        showcase with rich visuals and seamless navigation on
                        any screen.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, create me a gift guide for my girlfriend&apos;s
                    birthday! Show me 5 different styles of presents, with
                    budgets, where to buy them, and what to pair them with.&quot;
      </div>
      <span
        aria-hidden="true"
