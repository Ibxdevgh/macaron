...
const screenshots = [
  {
    src: "/assets/_next/68941ce3a5f5880a362aaa7c-1-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68941ce3a5f5880a362aaa7c-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68941ce3a5f5880a362aaa7c-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68941ce3a5f5880a362aaa7c-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Calorie Counter — Track every bite, shape your wellness journey | Macaron
      - Macaron
    </title>
    <meta
      name="description"
      content="Track your daily calories and nutrition goals like a pro! Log meals from our huge food library, see your remaining calories at a glance, and watch your progress..."
    />
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68941ce3a5f5880a362aaa7c.png"
    />
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68941ce3a5f5880a362aaa7c.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Track your daily calories and nutrition goals like a pro! Log meals from our huge food library, see your remaining calories at a glance, and watch your progress unfold in colorful charts. Smart portion sizing makes logging a breeze — stay on top of your health journey with zero hassle.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Log your meals in seconds with our smart food search that instantly calculates calories based on your portions.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See your daily calorie goal, what you&apos;ve eaten, and calories remaining, all updated in real-time as you log meals.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track your eating patterns with an easy-to-read weekly view that shows how your daily calories trend over time.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find nutrition info for thousands of common foods and ingredients, making it simple to track what you eat.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Set your own daily calorie target to match your personal health and fitness journey.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Type in any food and instantly see matching options from our comprehensive database, saving you time and effort.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&apos;s create a Calorie Home tracker! I want to log my meals with food names and portions, backed by a calorie database. Help me track my daily calories, see how close I am to my goal (like 1500 kcal), and chart my 7-day progress to keep my diet on track!&quot;
      </div>
      <span
        aria-hidden="true"
