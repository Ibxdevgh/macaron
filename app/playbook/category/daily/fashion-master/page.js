...
export default function FashionMaster() {
const screenshots = [
  {
    src: "/assets/_next/38eadb7f-3758-4622-a213-57166f6e5ee9.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/06647a72-8048-457d-ac1b-30d100057dfe.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/173e4c69-a175-46bc-8c92-ebdda11d0319.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/e530ae40-7a4a-4e4b-964e-f7adc859f835.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Fashion Master — Try on clothes instantly in our virtual fitting room |
      Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Create stunning virtual try-ons in seconds! Upload a pose and your dream outfit — watch as AI seamlessly fits the clothes while keeping the original stance. Per..."
    />
    <meta property="og:title" content="Fashion Master" />
    <meta
    ...
    <meta name="twitter:title" content="Fashion Master" />
    <meta
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Create stunning virtual try-ons in seconds! Upload a pose and your dream outfit — watch as AI seamlessly fits the clothes while keeping the original stance. Perfect for planning your looks or previewing new styles.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See how any outfit looks on you while keeping your natural pose and expression.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Transform your style instantly with an effortless interface that puts the spotlight on results.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get a complete head-to-toe view of your new look, perfectly fitted to your shape.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Apply the outfit to the character while maintaining the same pose, and create a full-body photo.
      </div>
      <span
        aria-hidden="true"
