...
export default function UltimateMealPlanner() {
const screenshots = [
  {
    src: "/assets/_next/6892e5b6aa6e16ed138ee4ca-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892e5b6aa6e16ed138ee4ca-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892e5b6aa6e16ed138ee4ca-3.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      The Ultimate Meal Planner — Meal plans that power your fitness journey |
      Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Ready to level up your nutrition game? Tell us your goals and stats, and we&#x27;ll craft the perfect meal plan just for you! Get daily calorie targets, macro breakd..."
    />
    <meta property="og:title" content="The Ultimate Meal Planner" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6892e5b6aa6e16ed138ee4ca.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="The Ultimate Meal Planner" />
    <meta
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="The Ultimate Meal Planner icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/6892e5b6aa6e16ed138ee4ca.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Track every bite, shape your wellness journey
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to level up your nutrition game? Tell us your goals and
                  stats, and we&#x27;ll craft the perfect meal plan just for
                  you! Get daily calorie targets, macro breakdowns, and three
                  delicious meal ideas that fit your needs. Save your favorite
                  plans to stay on track and crush those fitness goals!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Tell us your story and fitness dreams, and we&#x27;ll
                      craft the perfect nutrition plan that fits your life like
                      a glove.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get your personalized daily calorie blueprint with ideal
                      protein, carb, and fat ratios – all perfectly matched to
                      your body and goals.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Unlock three perfectly balanced meals every day that match
                      your nutrition needs and power up your fitness journey.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Not feeling today&#x27;s menu? Just tap for fresh meal
                      ideas that still hit your nutrition targets perfectly.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your nutrition journey on track with all your meal
                      plans and calculations in one handy spot.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Let&#x27;s make a fitness meal planner that works for you!
                  Just tell me your stats and goals — building muscle or losing
                  fat — and I&#x27;ll crunch the numbers using proven BMR
                  formulas. You&#x27;ll get your perfect daily calories and
                  macro splits, plus 3 tasty meal ideas that hit those targets.
                  Mix and match different meal combos, and track what works
                  best. Ready to fuel your fitness journey?
      </div>
      <span
        aria-hidden="true"
