...
export default function HairColorMagic() {
const screenshots = [
  {
    src: "/assets/_next/18351729-53a0-484a-baf0-081a764b71e0.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/847b17ee-9562-4fd5-8166-d7217c27e417.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/7166d843-05c5-4b48-a3ad-8cf98be9fde6.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Hair color magic wand — Your instant virtual hair salon — try new looks in
      seconds | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Ready to try on a whole new look? Upload your photo and instantly preview trendy hairstyles like wolf cuts, layered bobs, retro perms and more! Mix and match st..."
    />
    <meta property="og:title" content="Hair color magic wand" />
    <meta
    ...
    <meta name="twitter:title" content="Hair color magic wand" />
    <meta
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Hair color magic wand
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Your instant virtual hair salon — try new looks in seconds
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to try on a whole new look? Upload your photo and instantly preview trendy hairstyles like wolf cuts, layered bobs, retro perms and more! Mix and match styles and colors to find your perfect match before heading to the salon.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get a sneak peek of your new look! Just snap a photo, pick your style, and see the magic happen instantly.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into today&apos;s hottest looks! From wolf cuts to textured bobs, retro curls to K-beauty styles — all just a tap away.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Dream up your perfect style! Describe any look you want, and watch as we bring your vision to life.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your go-to packing lists ready for future adventures - never forget the essentials again!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Transform your look stress-free with our super-smooth, easy-to-use interface.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Upload a photo and transform your hairstyle while keeping your face untouched!
        Pick from our style collection or dream up your own unique look.
      </div>
      <span
        aria-hidden="true"
