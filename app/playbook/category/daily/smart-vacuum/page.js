...
const screenshots = [
  {
    src: "/assets/_next/68923e96c28019528d81a5f7-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68923e96c28019528d81a5f7-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68923e96c28019528d81a5f7-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68923e96c28019528d81a5f7-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Smart Vacuum Finder — Your floors have met their perfect cleaning
      companion | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Get your perfect robot vacuum match! Tell us about your home, floors, and furry friends, and we&#39;ll instantly find your top 3 options with prices. No more endles..."
    />
    <meta property="og:title" content="Smart Vacuum Finder" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68923e96c28019528d81a5f7.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Smart Vacuum Finder" />
    <meta
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68923e96c28019528d81a5f7.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  Your floors have met their perfect cleaning companion
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Get your perfect robot vacuum match! Tell us about your home, floors, and furry friends, and we&apos;ll instantly find your top 3 options with prices. No more endless research — just quick, personalized picks for your space.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Tell us about your space in three quick questions about size, flooring, and pets to find your perfect robot vacuum match!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get instant matches for the top three robot vacuums that perfectly fit your home&apos;s unique needs.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See upfront pricing and detailed specs for each recommended model to make the right choice.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Have furry family members? Discover robot vacuums specially picked to tackle pet hair and dander.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find the perfect vacuum for your exact flooring – whether it&apos;s hardwood, tile, or carpet.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Get recommendations matched to your home&apos;s square footage for just the right cleaning coverage.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&apos;s create a Smart Vacuum Finder website! Help users discover the perfect robot vacuum by having them select their home size {"(≤50㎡, 50-100㎡, >100㎡)"}, floor type (wood, tile, carpet), and whether they have pets. Then show them the top 3 matching models with brand, model name, and price range.&quot;
      </div>
      <span
        aria-hidden="true"
