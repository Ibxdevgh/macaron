...
export default function HollidayGiftGuide() {
const screenshots = [
  {
    src: "/assets/_next/6894436c38b4126bb126cb1d-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6894436c38b4126bb126cb1d-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6894436c38b4126bb126cb1d-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6894436c38b4126bb126cb1d-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Holiday Gift Guide — Holiday planning that makes your season magical |
      Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Ready to conquer Christmas planning? Jump in and take control with smart shopping lists, budget tracking, and a month-by-month game plan! Sort gifts into 5 cate..."
    />
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6894436c38b4126bb126cb1d.png"
    />
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6894436c38b4126bb126cb1d.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Holiday planning that makes your season magical
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to conquer Christmas planning? Jump in and take control with smart shopping lists, budget tracking, and a month-by-month game plan! Sort gifts into 5 categories, discover money-saving hacks, and unlock pro storage strategies. Turn holiday chaos into your winning season!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Smart Holiday Categories
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into our beautifully organized Christmas collection!
                      Find everything from decorations to gifts, with handy
                      price guides for each category.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Master your holiday spending with personalized budget
                      breakdowns and smart saving tricks for everything on your
                      list.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
             Shop like a pro with our month-by-month calendar that
                      reveals the best times to score deals on every item.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your holiday treasures perfectly organized with
                      custom storage tricks for every type of item.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Easy Mobile Planning
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Plan your dream Christmas shopping anywhere — our
                      beautiful design works smoothly on both phone and
                      computer.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&#x27;s build your ultimate Christmas shopping guide!
                  I&#x27;ll help you track decorations, gifts, toys, festive
                  foods, and party supplies — complete with budget tiers, where
                  to buy, early-bird tips, and smart storage tricks for each
                  category.&quot;
      </div>
      <span
        aria-hidden="true"
