...
const screenshots = [
  {
    src: "/assets/_next/6893a06e96e8fcf6105f896c-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f896c-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f896c-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893a06e96e8fcf6105f896c-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Travel Match Planner — Level up your game day travel plans | Macaron -
      Macaron
    </title>
    <meta
      name="description"
      content="Plan your ultimate sports adventure from NYC to Brazil! Track flights, book fan-friendly hotels, and catch the matches you love. Get detailed budgets, safety ti..."
    />
    <meta property="og:title" content="Travel Match Planner" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6893a06e96e8fcf6105f896c.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Travel Match Planner" />
    <meta
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893a06e96e8fcf6105f896c.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Travel Match Planner
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Level up your game day travel plans
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      Plan your ultimate sports adventure from NYC to Brazil! Track flights, book fan-friendly hotels, and catch the matches you love. Get detailed budgets, safety tips, and game schedules all in one place — your perfect match day starts here!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find the perfect flights, transfers, and transport options from New York to Brazil, tailored to your match schedule.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Discover comfortable hotels near the venue and plan your daily activities around the big game.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See a clear breakdown of all your travel costs, from flights and hotels to match tickets and meals.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Stay informed with essential safety tips, local guidance, and health recommendations for your Brazilian adventure.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Browse trip details seamlessly on any device with our mobile-friendly design that puts everything at your fingertips.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Explore your travel plans through an intuitive interface that shows exactly what to expect at each step.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, create a travel guide for my sports trip from New York to Brazil! Include round-trip flights, getting around cities, where to stay, match times, fun daily activities, budget breakdown, plus tips for staying safe and sun-smart!&quot;
      </div>
      <span
        aria-hidden="true"
