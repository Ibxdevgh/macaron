...
export default function FitnessPlanCreator() {
const screenshots = [
  {
    src: "/assets/_next/6892e5caaa6e16ed138ee4d1-12.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892e5caaa6e16ed138ee4d1-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892e5caaa6e16ed138ee4d1-3-1.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6892e5caaa6e16ed138ee4d1-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      Fitness Plan Creator — Your Body, Your Rules: Personal Fitness Journey
      Planner | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Ready to level up your fitness? Just tell me your stats and goals — muscle gains or fat loss — and I&#x27;ll craft the perfect weekly workout plan for you! Track you..."
    />
    <meta property="og:title" content="Fitness Plan Creator" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/6892e5caaa6e16ed138ee4d1.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Fitness Plan Creator" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6892e5caaa6e16ed138ee4d1.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
        Ready to level up your fitness? Just tell me your stats and goals — muscle gains or fat loss — and I&apos;ll craft the perfect weekly workout plan for you! Track your progress, juggle multiple routines, and update your plan anytime as you get stronger. Your journey, your pace, always perfectly matched to where you&apos;re at!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into action in minutes! Enter your measurements and details to unlock workouts made just for you.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Set Your Success Path
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            What&apos;s your fitness quest? Building muscle or burning fat — tell us your goals and we&apos;ll craft your perfect training journey.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Score instant weekly workout plans that match your goals and fit your schedule. Your personal trainer in your pocket!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Level up your fitness game! Track progress, update workouts, and review your achievements — all in one spot.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Mix up your routine and discover what works best! Easily switch between different workout styles while tracking your success.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Let&apos;s build your personal fitness companion! Share your body stats (height, weight, age, gender) and measurements (chest, waist, hips, arms, legs). Tell me your goal—bulk up or slim down—and I&apos;ll craft a custom weekly workout plan. Choose your training frequency, duration, and target areas. Want fresh ideas? Just ask! You can always check or clear your workout history.
      </div>
      <span
        aria-hidden="true"
