...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta property="og:title" content="Bubble Tea Filter" />
    ...
    <meta name="twitter:title" content="Bubble Tea Filter" />
    <meta
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6892edfcaa6e16ed138ee513.png"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Find your perfect bubble tea match! Set your sugar and calorie preferences, and discover delicious drinks that fit your healthy lifestyle. Compare ingredients, check nutrition facts, and sort by health score or fan favorites — enjoying milk tea your way has never been easier.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Slide to your perfect sweetness level and discover drinks that match your taste perfectly.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Pick your calorie target and find milk tea options that fit right into your daily goals.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Explore our milk tea collection with detailed nutrition facts and ingredients for smarter sipping.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find your ideal drink fast — sort by calories, sweetness, or what&apos;s trending now.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Quick visual guides show you exactly how sweet each drink is before you order.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Spot calorie counts instantly on every drink card — no hunting needed.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Macaron, create me a mini-app to find milk teas with less sugar and calories!&quot;
      </div>
      <span
        aria-hidden="true"
