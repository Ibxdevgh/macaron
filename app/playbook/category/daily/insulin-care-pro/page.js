...
export default function InsulinCArePro() {
const screenshots = [
  {
    src: "/assets/_next/689379496eea5637c0438b3d-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689379496eea5637c0438b3d-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689379496eea5637c0438b3d-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689379496eea5637c0438b3d-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
    <title>
      InsulinCare Pro — Smart insulin planning, tailored just for you | Macaron
      - Macaron
    </title>
    <meta
      name="description"
      content="Track your insulin therapy with confidence — plan your weekly doses, monitor blood sugar safely, and always know what to do in emergencies. The simple color gui..."
    />
    <meta property="og:title" content="InsulinCare Pro" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/689379496eea5637c0438b3d.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="InsulinCare Pro" />
    <meta
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/689379496eea5637c0438b3d.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Smart insulin planning, tailored just for you
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Track your insulin therapy with confidence — plan your weekly doses, monitor blood sugar safely, and always know what to do in emergencies. The simple color guide helps you manage basal and mealtime insulin while following key safety steps.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Stay on track with a personalized weekly schedule showing exactly when to take your insulin and how much you need.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Check your blood sugar at the right times with easy-to-follow guidelines that help you stay in your target range.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Feel confident with step-by-step emergency instructions and practical tips to prevent low blood sugar episodes.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            View your complete care plan in a simple, color-coded calendar that works perfectly on your phone or computer.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Access your complete diabetes management plan in one organized place, from daily schedules to emergency protocols.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, create a weekly insulin guide for me: map out my basal and mealtime doses in a table, plus smart tips for blood sugar monitoring and handling low blood sugar!&quot;
      </div>
      <span
        aria-hidden="true"
