...
const screenshots = [
  {
    src: "/assets/_next/68936769def845e53c83c05d-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68936769def845e53c83c05d-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68936769def845e53c83c05d-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68936769def845e53c83c05d-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Your Personal Meal Guide — Western Food Calorie Guide: Know Your Favorites
      | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Dive into the world of food facts! See what&#39;s really on your plate with this visual guide to popular Western dishes. Compare 10 common meals at a glance, from c..."
    />
    <meta property="og:title" content="Your Personal Meal Guide" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68936769def845e53c83c05d.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Your Personal Meal Guide" />
    <meta
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68936769def845e53c83c05d.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Western Food Calorie Guide: Know Your Favorites
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Dive into the world of food facts! See what&apos;s really on your plate with this visual guide to popular Western dishes. Compare 10 common meals at a glance, from calories to nutrients, all through easy-to-read charts. Perfect for quick checks or deep dives into your daily nutrition game!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Dive into detailed nutrition facts for 10 popular Western dishes! From juicy burgers to fresh salads, everything you need in one spot.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Visual Nutrition Comparison
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Compare your meal choices like a pro! Easy-to-read charts show you calories and nutrients side by side..
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track how each meal fits your daily goals with simple percentages and smart recommendations to keep you on target.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find what you need in seconds with our clean, sleek layout that looks amazing on any screen.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Detailed Portion Guide
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Master your portions with precise serving sizes and complete nutrition breakdowns for smarter dining choices.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Nutrient Balance Viewer
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See your meal&apos;s protein, fat, and carb balance instantly with our quick-view nutrition display.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Create an offline nutrition guide for Western favorites with Macaron! Track 10 classic dishes with full nutritional facts, portion sizes, and smart visualizations (calorie bars + nutrient radar). Plus: get personalized daily calorie tips!&quot;
      </div>
      <span
        aria-hidden="true"
