...
export default function FashionVip() {
const screenshots = [
  {
    src: "/assets/_next/68936111def845e53c83bf23-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68936111def845e53c83bf23-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68936111def845e53c83bf23-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68936111def845e53c83bf23-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Fashion Launch VIP Pass — Elegance meets digital dress code | Macaron -
      Macaron
    </title>
    <meta
      name="description"
      content="Create stunning fashion event invites with our sleek charcoal and rose gold design. Showcase your event details in style — from date to dress code — with a resp..."
    />
    <meta property="og:title" content="Fashion Launch VIP Pass" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68936111def845e53c83bf23.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Fashion Launch VIP Pass" />
    <meta
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Fashion Launch VIP Pass icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/68936111def845e53c83bf23.png"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Fashion Launch VIP Pass
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Elegance meets digital dress code
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Create stunning fashion event invites with our sleek charcoal and rose gold design. Showcase your event details in style — from date to dress code — with a responsive layout that looks perfect on any device. Ideal for fashion brands who want to make every invitation count.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Elegant Event Showcase

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Immerse yourself in our fashion launch, where sophisticated charcoal gray meets rose gold to create an atmosphere of pure luxury.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Everything you need to know - from timing to dress code - beautifully arranged in one smooth, intuitive view.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Perfect Viewing Anywhere

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Your invitation looks stunning whether you&apos;re checking details on your phone or desktop - perfect viewing, every time.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump right in with one click - your complete invitation appears instantly, no waiting, no extra steps.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Experience every detail through carefully curated elegant fonts that make your exclusive invitation truly special.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey there! Let me help you design that autumn fashion launch invitation. Just tell me the date, location, dress code and check-in details, and I&apos;ll create a stunning invite with those elegant charcoal gray and rose gold colors. What&apos;s the event info you&apos;d like me to include?&quot;
      </div>
      <span
        aria-hidden="true"
