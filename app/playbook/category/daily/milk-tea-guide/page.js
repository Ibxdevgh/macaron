...
const screenshots = [
  {
    src: "/assets/_next/689379316eea5637c0438b35-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689379316eea5637c0438b35-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689379316eea5637c0438b35-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689379316eea5637c0438b35-4.png",
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/689379316eea5637c0438b35.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                    Milk Tea Nutrition Guide
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                    Know your bubble tea nutrition facts
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Dive into the world of bubble tea stats! Compare 10 popular milk tea drinks with interactive charts and easy-to-read tables. Track calories, sugar, and more — perfect for making smarter choices about your favorite treats!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Easy Nutrition Lookup
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Compare calories, sugar, and fat content across your favorite milk tea drinks at a glance with our simple nutrition table.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Visual Drink Comparisons
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            See colorful charts that make it easy to understand how different milk tea drinks stack up against each other.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get detailed serving information and nutritional breakdowns for each milk tea variety to make informed choices.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Access all nutrition information seamlessly whether you&apos;re on your phone or computer.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find nutrition facts for the most popular milk tea drinks all in one convenient place.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, create a handy guide showing calories and nutrition facts for 10 popular milk teas! I&apos;d love to see their sugar and fat content, plus some cool charts to visualize it all.&quot;
      </div>
      <span
        aria-hidden="true"
