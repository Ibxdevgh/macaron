...
const screenshots = [
  {
    src: "/assets/_next/6892def07bac40bbf77f6e19-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892def07bac40bbf77f6e19-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892def07bac40bbf77f6e19-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6892def07bac40bbf77f6e19-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6892def07bac40bbf77f6e19.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Track your family&apos;s spending the easy way! Just speak or type expenses naturally, and watch them sort themselves into categories. See who spent what with colorful charts, spot budget trends at a glance, and keep everyone in sync with your family&apos;s financial goals.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Speak or Type Your Expenses

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Just say or type what you spent, like &apos;lunch $15,&apos; and see your expense tracker update instantly.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Purchases automatically sort into categories like food, transport, or entertainment, making budget tracking a breeze.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Colorful charts show exactly how your family spends, highlighting areas where you could save.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep a history of spending patterns or start fresh anytime, with all data safely stored.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Add expenses like chatting with a friend, with a simple tap on the microphone.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Beautiful Budget Visuals

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                See your spending habits through interactive charts that make budgeting clear and simple.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Build your smart family budget tracker! Record expenses naturally by voice or text — &apos;Groceries $30&apos;, &apos;Uber $18&apos;, &apos;Dentist $120&apos;, &apos;Netflix $15&apos;. Watch as your spending auto-sorts into categories like food, transport, healthcare, and entertainment, with clear tracking for each family member. Dive into colorful charts and get smart insights on where to save. Keep or reset your data anytime!&quot;
      </div>
      <span
        aria-hidden="true"
