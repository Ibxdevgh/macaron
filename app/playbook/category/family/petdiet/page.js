...
export default function PetDiet() {
const screenshots = [
  {
    src: "/assets/_next/689344aab492847205282233-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689344aab492847205282233-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689344aab492847205282233-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689344aab492847205282233-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      PetDiet Planner - Keep your furry friend healthy and happy — Healthy meals
      for your furry friend | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Create the perfect meal plan for your furry friend! Tell us about your pet&#x27;s breed, age, and lifestyle, and we&#x27;ll whip up a personalized diet that hits all the ..."
    />
    <meta
      property="og:title"
      content="PetDiet Planner - Keep your furry friend healthy and happy"
    />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/689344aab492847205282233.png"
    />
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="PetDiet Planner - Keep your furry friend healthy and happy icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/689344aab492847205282233.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Create the perfect meal plan for your furry friend! Tell us
                  about your pet&#x27;s breed, age, and lifestyle, and
                  we&#x27;ll whip up a personalized diet that hits all the right
                  spots. Track meals, watch their progress, and even get tasty
                  homemade recipes — everything you need to keep your pet
                  healthy and happy!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Tell us about your furry friend&#x27;s breed, age, weight,
                      and daily adventures — we&#x27;ll craft the perfect
                      nutrition plan just for them!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get daily meal suggestions with precise portions,
                      perfectly matched to your pet&#x27;s unique needs and
                      goals.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Whip up delicious, healthy meals your pet will adore with
                      our simple step-by-step recipes.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch your pet thrive with clear, colorful charts tracking
                      their meals and weight progress.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your pet&#x27;s health journey on track with quick
                      insights into meals, weight trends, and tailored care
                      tips.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Mix and match between kibble portions and fresh recipes to
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&#x27;s build a Pet Diet Buddy app! Help
                  me craft the perfect meal plan for my furry friend. Just pop
                  in their breed, age, weight, and how active they are —
                  you&#x27;ll figure out exactly what they need and suggest the
                  best food, from kibble to fresh ingredients. Plus, give me
                  easy-to-follow recipes and keep track of their meals and
                  weight changes so I can make sure they&#x27;re staying
                  healthy!&quot;
      </div>
      <span
        aria-hidden="true"
