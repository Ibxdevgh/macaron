...
export default function MotherGuide() {
const screenshots = [
  {
    src: "/assets/_next/6893a06d96e8fcf6105f8957-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893a06d96e8fcf6105f8957-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893a06d96e8fcf6105f8957-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893a06d96e8fcf6105f8957-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893a06d96e8fcf6105f8957.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to be the best gift-giver this Mother&apos;s Day? Jump in and discover hand-picked treasures across five special categories! From beauty must-haves to unforgettable experiences, you&apos;ll get personalized suggestions with exact prices and where to shop. Plus, creative presentation ideas to make every gift extra special — all while keeping your budget happy!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Explore five thoughtfully selected gift categories, from relaxing spa experiences to heartfelt personalized keepsakes, each with hand-picked recommendations.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Smart Budget Options

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Discover the perfect gift within your budget with clearly marked price ranges, from affordable treasures to premium luxuries.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find exactly where to shop for each gift, whether online or at local stores in your area.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Learn creative ways to make your Mother&apos;s Day gift extra special with personalized presentation ideas and meaningful timing suggestions.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Visual Gift Inspiration

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Browse beautiful images of each gift option to help you visualize the perfect present for your mom.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                Enjoy a smooth shopping experience on any device with our easy-to-navigate design that works beautifully on phones and computers.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Macaron, create a Mother&apos;s Day gift guide for me with five gift categories, price ranges, where to buy them, and thoughtful giving tips.&quot;
      </div>
      <span
        aria-hidden="true"
