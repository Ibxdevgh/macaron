...
const screenshots = [
  {
    src: "/assets/_next/6892edeaaa6e16ed138ee50c-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6892edeaaa6e16ed138ee50c-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6892edeaaa6e16ed138ee50c-3.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6892edeaaa6e16ed138ee50c.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Turn your cat&apos;s mealtime into a science! Enter your furry friend&apos;s age and weight to unlock personalized food recommendations, perfect portions, and expert nutrition tips. We&apos;ll help you pick the purr-fect diet to keep your companion healthy and happy.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump in with your cat&apos;s age and weight — get personalized nutrition guidance in seconds!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get tailored food picks and perfect portions matched to your cat&apos;s unique needs and life stage.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Discover exactly what your cat needs and why, with clear breakdowns of recommended foods.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your cat at their ideal weight with precise, personalized portion guidance.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch your cat thrive at every age with diet recommendations that grow alongside them.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Macaron, help me find the perfect cat food for my furry friend based on their age and weight!&quot;
      </div>
      <span
        aria-hidden="true"
