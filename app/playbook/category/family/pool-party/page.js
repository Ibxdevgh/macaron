...
const screenshots = [
  {
    src: "/assets/_next/68939ef896e8fcf6105f8932-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68939ef896e8fcf6105f8932-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68939ef896e8fcf6105f8932-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68939ef896e8fcf6105f8932-4.png",
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68939ef896e8fcf6105f8932.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  ...
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Set your digital invites to summer mode
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Ready to make waves? Design stunning pool party invites with a tropical flair! Add your party details, dress code and fun reminders — all wrapped in bright summer vibes. Your invite looks perfect everywhere, from phones to laptops, so guests never miss a splash!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Find everything you need to know about the Summer Pool Party, from time and location to what to wear, all beautifully organized on one page.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Immerse yourself in the party mood with cheerful palm trees and poolside graphics that bring the summer vibe to life.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Helpful Party Prep Guide

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get ready for the fun with an easy-to-read list of what to bring, safety tips, and party guidelines.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           View your invitation perfectly whether you&apos;re on your phone, tablet, or computer screen.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, create me a fun pool party invite! Include all the essentials — event name, when & where, what to wear, plus some friendly tips. Make it pop with tropical vibes!&quot;
      </div>
      <span
        aria-hidden="true"
...
<div className="mb-8 sm:mb-12">
          ...
          <div className="mb-6 sm:mb-8">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                <Link
    className="block"
    href="/playbook/category/family/star-reader"
  >
      ...
      <div className="w-full flex-1 relative overflow-hidden flex flex-col">
        ...
        <div className="flex-1 relative flex items-center justify-center pointer-events-none mt-3">
          <div
            ...
            style={{
              backgroundImage:
                "url(/assets/project_template/68940c52129a8b22ebbd189c-1.png)"
            }}
          />
        </div>
      </div>
  ...
  <Link
    className="block"
    href="/playbook/category/family/hawaii-wedding"
  >
    <div className="group relative w-full flex flex-col rounded-3xl overflow-hidden cursor-pointer bg-[#F1EFE9] border border-[#E9E7E2] transition-all duration-300 ease-out hover:shadow-lg h-[364px]">
      <div className="w-full flex-1 relative overflow-hidden flex flex-col">
        <div className="p-5 pb-2 flex flex-col z-30 flex-shrink-0">
          ...
          <p className="text-[16px] leading-[1.3] text-[#595856] line-clamp-2 min-h-[2.6em]">
            Paradise plans for your perfect day
          </p>
        </div>
        <div className="flex-1 relative flex items-center justify-center pointer-events-none mt-3">
          <div
            role="img"
            aria-label="Hawaii Wedding Hub screenshot 1"
            className="top-0 absolute w-[60%] aspect-[9/19.5] rounded-[12px] bg-white shadow-xl z-20 transition-transform duration-300 ease-out group-hover:-translate-y-3 bg-origin-border bg-cover bg-center"
            style={{
              backgroundImage:
                "url(/assets/project_template/689378d16eea5637c0438b2b-1.png)"
            }}
          />
        </div>
      </div>
  ...
  <Link
    className="block"
    href="/playbook/category/family/lunar-new-year"
  >
    <div className="group relative w-full flex flex-col rounded-3xl overflow-hidden cursor-pointer bg-[#F1EFE9] border border-[#E9E7E2] transition-all duration-300 ease-out hover:shadow-lg h-[364px]">
      <div className="w-full flex-1 relative overflow-hidden flex flex-col">
        <div className="p-5 pb-2 flex flex-col z-30 flex-shrink-0">
          ...
          <p className="text-[16px] leading-[1.3] text-[#595856] line-clamp-2 min-h-[2.6em]">
            Stock up for a joyful New Year celebration
          </p>
        </div>
        <div className="flex-1 relative flex items-center justify-center pointer-events-none mt-3">
          <div
            role="img"
            aria-label="Lunar New Year Shopping List screenshot 1"
            className="top-0 absolute w-[60%] aspect-[9/19.5] rounded-[12px] bg-white shadow-xl z-20 transition-transform duration-300 ease-out group-hover:-translate-y-3 bg-origin-border bg-cover bg-center"
            style={{
              backgroundImage:
                "url(/assets/project_template/689472fc8232695687565e22-1.png)"
            }}
          />
        </div>
      </div>
