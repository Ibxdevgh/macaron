...
export default function PregnancyWorkout() {
const screenshots = [
  {
    src: "/assets/_next/6894c7e71e005cbfbd2448c8-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6894c7e71e005cbfbd2448c8-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6894c7e71e005cbfbd2448c8-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6894c7e71e005cbfbd2448c8-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6894c7e71e005cbfbd2448c8.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Stay fit and healthy during your pregnancy journey! Create personalized workout plans that adapt to each trimester, track your progress, and build your favorite routines. With smart recommendations based on your pregnancy week and comfort level, you&apos;ll maintain the perfect balance of safety and activity — giving you and your baby the best care possible.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Smart Pregnancy Workouts

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Personalized exercise recommendations that match your stage of pregnancy, keeping you and your baby safe and healthy.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Kickstart your fitness journey by sharing basic details about you and your pregnancy in a simple, guided process.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Follow clear workout instructions, complete with warm-ups, duration guidelines, and safety tips crafted for expecting mothers.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Save your go-to pregnancy-safe exercises to shape a personalized workout routine just for you.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Stay motivated by tracking your fitness journey during pregnancy with an easy-to-read dashboard of your activities.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
               Easily manage your exercise routine by saving new workouts or removing ones that don&apos;t fit your style.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
               Find exercises perfectly aligned with your current pregnancy stage, from early weeks to the third trimester.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s create a Pregnancy Fitness Coach app! Enter your height, weight, age, number of babies, and current pregnancy week. Get three personalized prenatal exercises perfect for your trimester. Each workout comes with stage-specific benefits, recommended intensity and timing, plus pre and post-exercise stretching tips. Save your favorite routines, remove individual exercises, or reset your collection. Want to update your info? Head to your profile to view and edit your fitness data anytime.&quot;
      </div>
      <span
        aria-hidden="true"
