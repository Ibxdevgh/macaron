...
export default function ParentBp() {
const screenshots = [
  {
    src: "/assets/_next/68936c66def845e53c83c0d0-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68936c66def845e53c83c0d0-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68936c66def845e53c83c0d0-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68936c66def845e53c83c0d0-4.png",
...
<>
  <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <meta name="theme-color" content="#ffffff" />
   <title>
      Parent&#x27;s Blood Pressure Tracker — Keep your parents&#x27; blood
      pressure in check | Macaron - Macaron
    </title>
    <meta
      name="description"
      content="Track your parents&#x27; heart health with care! Log blood pressure readings, get instant alerts, and spot trends with easy-to-read weekly and monthly charts. With 9..."
    />
    <meta property="og:title" content="Parent&#x27;s Blood Pressure Tracker" />
    <meta
    ...
    <meta
      property="og:image"
      content="https://macaron-ai.oss-ap-southeast-1.aliyuncs.com/image/project_icon/68936c66def845e53c83c0d0.png"
    />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Parent&#x27;s Blood Pressure Tracker" />
    <meta
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="Parent&#x27;s Blood Pressure Tracker icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/68936c66def845e53c83c0d0.jpg"
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto text-center sm:text-left">
                  <h1 className="text-2xl sm:text-4xl md:text-3xl font-serif font-bold text-gray-900 mb-1 sm:mb-2 break-words">
                   Parent&#x27;s Blood Pressure Tracker
                  </h1>
                  <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                   Keep your parents&#x27; blood pressure in check
                  </p>
                </div>
              </div>
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
        Track your parents&#x27; heart health with care! Log blood
                  pressure readings, get instant alerts, and spot trends with
                  easy-to-read weekly and monthly charts. With 90 days of
                  history saved, sharing updates with doctors is a breeze —
                  keeping your loved ones healthy has never been simpler.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Quick Blood Pressure Log
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track your daily readings in just a few taps — complete
                      with date and time for each measurement.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Health Alerts at a Glance
            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get instant visual alerts when readings are outside normal
                      range, so you&#x27;re always in the know.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
             Spot trends easily with clear weekly charts showing your
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Follow your health journey with monthly overview charts
                      that reveal your long-term trends.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep three months of readings at your fingertips, ready
                      whenever you need to check back.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
                See all your key health stats on one clean, organized
                      screen right when you open the app.
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
       Macaron, let&#x27;s create the Health Guardian app. We&#x27;ll
                  need a simple way for users to log their parents&#x27; blood
                  pressure readings with date, time, and pressure values. Mark
                  readings outside the healthy range (90-140/60-90 mmHg) in red
                  with an 「Attention Needed」 notice. Show weekly and monthly
                  trend charts on the home screen, with a 90-day data history.
      </div>
      <span
        aria-hidden="true"
