...
const screenshots = [
  {
    src: "/assets/_next/689364b3def845e53c83bfec-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689364b3def845e53c83bfec-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689364b3def845e53c83bfec-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689364b3def845e53c83bfec-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/689364b3def845e53c83bfec.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Track your little one&apos;s growth journey like a pro! Record daily stats, capture precious milestones, and watch their progress come to life with beautiful charts. Perfect for sharing those special moments with family and keeping your doctor in the loop!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Easy Growth Tracking

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track your baby&apos;s height, weight, and sleep with just a few taps - create a detailed record of their amazing journey!
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Milestone Memory Keeper

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Capture every precious moment, from first smiles to first steps. Add dates and personal notes to treasure these special times forever.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch your little one&apos;s story unfold through beautiful, interactive charts that bring their growth journey to life.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Relive your baby&apos;s precious moments in a beautifully organized timeline - from measurements to milestone memories.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Share your baby&apos;s growth story with stunning monthly reports featuring charts and milestone memories.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Let&apos;s create a BabyDiary website with Macaron! Track your little one&apos;s journey with easy data entry for height, weight, and sleep patterns — all beautifully displayed in growth charts. Capture precious milestones like first smiles, rolling over, and those magical first steps. Browse through memories in the timeline view, and share the joy with monthly PDF reports of your baby&apos;s progress.&quot;
      </div>
      <span
        aria-hidden="true"
    ...
    <div className="group relative w-full flex flex-col rounded-3xl overflow-hidden cursor-pointer bg-[#F1EFE9] border border-[#E9E7E2] transition-all duration-300 ease-out hover:shadow-lg h-[364px]">
      <div className="w-full flex-1 relative overflow-hidden flex flex-col">
        ...
        <div className="flex-1 relative flex items-center justify-center pointer-events-none mt-3">
          <div
            role="img"
            aria-label="Baby Food Journey screenshot 1"
            className="top-0 absolute w-[60%] aspect-[9/19.5] rounded-[12px] bg-white shadow-xl z-20 transition-transform duration-300 ease-out group-hover:-translate-y-3 bg-origin-border bg-cover bg-center"
            style={{
              backgroundImage:
                "url(/assets/project_template/68941203129a8b22ebbd18c4-1.png)"
            }}
          />
        </div>
      </div>
