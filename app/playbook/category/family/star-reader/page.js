...
const screenshots = [
  {
    src: "/assets/_next/68940c52129a8b22ebbd189c-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68940c52129a8b22ebbd189c-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68940c52129a8b22ebbd189c-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68940c52129a8b22ebbd189c-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68940c52129a8b22ebbd189c.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Turn reading into an exciting adventure! Track your daily books, earn shiny stars, and unlock special rewards as you build your reading streak. Watch your progress light up on a fun dashboard that shows off all your amazing achievements and finished stories!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track your reading adventures by logging books and pages as you go each day.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Earn sparkling stars for every reading session, plus bonus stars for consecutive reading days!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Watch your adventure unfold with a vibrant display of your stars, streaks, and conquered books!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Log your progress in seconds – just tell us what you&apos;re reading and how far you&apos;ve gone!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Showcase your reading victories at a glance, from fresh conquests to your longest streaks!
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Let&apos;s create a fun reading tracker for your kid! They can log their books and earn shiny stars along the way.
      </div>
      <span
        aria-hidden="true"
