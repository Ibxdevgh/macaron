...
const screenshots = [
  {
    src: "/assets/_next/68932ba9066d1f5e094dcebf-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/68932ba9066d1f5e094dcebf-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/68932ba9066d1f5e094dcebf-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/68932ba9066d1f5e094dcebf-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/68932ba9066d1f5e094dcebf.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Find your cat&apos;s purr-fect food match! Tell us about your furry friend&apos;s age, weight, and preferences, and we&apos;ll fetch three personalized recommendations. Compare prices, ingredients, and nutrition details to keep your feline companion happy and healthy.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into our fun quiz! Tell us about your cat&apos;s age, size, and what they love to find their purr-fect food match.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get your cat&apos;s custom food lineup! See prices and key ingredients at a glance, all matched to your furry friend&apos;s needs.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Tap any food to unlock the full scoop — discover ingredients and health perks that&apos;ll keep your cat happy and healthy!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Zip between your personalized picks and detailed food info with just a tap — quick and simple!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Browse tasty options in sleek, eye-catching cards that put the important details front and center.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        &quot;Hey Macaron, let&apos;s create MeowSelect! I want a mini-app that finds the perfect cat food. Just input my cat&apos;s age, weight, food preferences, and health info to get three tailored recommendations. Each suggestion shows the food name, price range, and key ingredients. Tap for more details to see the ingredient breakdown and health benefits. Keep it simple with a quick questionnaire — no chat or sharing needed.&quot;
      </div>
      <span
        aria-hidden="true"
