...
const screenshots = [
  {
    src: "/assets/_next/6893375ab49284720528208b-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/6893375ab49284720528208b-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/6893375ab49284720528208b-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/6893375ab49284720528208b-4.png",
                ...
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      ...
                      src="/assets/_next/6893375ab49284720528208b.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Create the perfect parenting strategy for your little one! Input your child&apos;s profile, personality, and care needs to unlock personalized activities and development tips. Track milestones, get emotional support guidance, and discover fun bonding moments that match your child&apos;s unique style.
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Create a special space for your little one! Just add simple details like age and daily routine, and we&apos;ll tune in to their unique world.
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center min-w-0 mb-1">
            <span className="w-[6px] h-[6px] rounded-full bg-black inline-block mr-3" />
            <span className="font-semibold text-foreground text-sm sm:text-base">
              Quick Personality Discovery

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Jump into four fun questions about your child! Help us get to know their special character and natural tendencies.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get thoughtful parenting tips perfectly matched to your child&apos;s age, personality, and daily life.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Unlock delightful activities and games hand-picked to boost your parent-child connection and support their growth!
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Keep your child&apos;s profile fresh as they grow – we&apos;ll make sure our guidance evolves right alongside them.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Let&apos;s create your personalized parenting guide! Start by telling us about your child: their name, gender, age (months for under 3, years for 3+), and where they spend their days (home, daycare, or kindergarten). A quick personality quiz helps us understand them better. Based on their unique profile, you&apos;ll get tailored parenting strategies, emotional support tips, and fun bonding activities perfect for your little one. Don&apos;t worry - you can update their info anytime as they grow!
      </div>
      <span
        aria-hidden="true"
