...
const screenshots = [
  {
    src: "/assets/_next/689344b4b492847205282238-1.png",
    alt: "App screenshot 1",
  },
  {
    src: "/assets/_next/689344b4b492847205282238-2.png",
    alt: "App screenshot 2",
  },
  {
    src: "/assets/_next/689344b4b492847205282238-3.png",
    alt: "App screenshot 3",
  },
  {
    src: "/assets/_next/689344b4b492847205282238-4.png",
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0 self-center sm:self-start">
                  ...
                  >
                    <Image
                      alt="The Cat Parent's Guide icon"
                      loading="lazy"
                      width={80}
                      height={80}
                      decoding="async"
                      ...
                      src="/assets/_next/689344b4b492847205282238.jpg"
  ...
  <div className="space-y-6 sm:space-y-8 max-w-[821px]">
    <div className="text-[#595856]">
      ...
      <p className="text-sm sm:text-base mb-4 sm:mb-6">
       Double-check your cat&apos;s medications in seconds! Enter your furry friend&apos;s symptoms, prescribed meds, and weight — we&apos;ll instantly verify if the treatment and dosage are purr-fect. Get expert insights on safer options if anything looks off. Your cat&apos;s health guardian is here!
      </p>
      ...
      <div className="space-y-3 sm:space-y-4">
        <div>
          <div className="flex items-center min-w-0 mb-1">
            ...
            <span className="font-semibold text-foreground text-sm sm:text-base">              
              Quick Pet Health Check

            </span>
          </div>
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Share your cat&apos;s symptoms, weight, and medications through a simple form made just for pet parents.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get instant peace of mind as we verify if your cat&apos;s medications and doses are perfectly matched to their needs.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
           Discover personalized treatment options and dose adjustments based on your cat&apos;s unique situation.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Get easy-to-understand explanations and helpful tips about your cat&apos;s treatment in simple, readable results.
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm sm:text-base leading-relaxed ml-5 flex-1">
            Track your cat&apos;s treatment progress at a glance with color-coded results showing what&apos;s working and what needs attention.
          </div>
        </div>
    ...
    <div className="text-[#595856] relative rounded-[24px] bg-[#F1EFE9] p-10 overflow-hidden">
      ...
      <div className="sm:text-lg leading-relaxed text-sm whitespace-pre-wrap break-words">
        Let&apos;s create a Cat Health Checker with Macaron! Input your kitty&apos;s symptoms and prescribed treatments, and I&apos;ll verify if the meds and dosages are just right for your furry friend. I&apos;ll analyze the treatment plan, check weight-based dosing, and flag any concerns. Plus, I&apos;ll suggest helpful alternatives and care tips to keep your cat purring!
      </div>
      <span
        aria-hidden="true"
